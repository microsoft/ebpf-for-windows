...
static ebpf_program_info_t _ebpf_xdp_program_info = {
    {"xdp", &_ebpf_xdp_context_descriptor, {0}, BPF_PROGRAM_TYPE_XDP},
...
static ebpf_program_info_t _ebpf_bind_program_info = {
    {"bind", &_ebpf_bind_context_descriptor, {0}, BPF_PROGRAM_TYPE_BIND}, 0, NULL};
...
static ebpf_program_info_t _ebpf_sock_addr_program_info = {
    {"sock_addr", &_ebpf_sock_addr_context_descriptor, {0}, BPF_PROGRAM_TYPE_CGROUP_SOCK_ADDR}, 0, NULL};
...
static ebpf_program_info_t _ebpf_sock_ops_program_info = {
    {"sockops", &_ebpf_sock_ops_context_descriptor, {0}, BPF_PROGRAM_TYPE_SOCK_OPS}, 0, NULL};
