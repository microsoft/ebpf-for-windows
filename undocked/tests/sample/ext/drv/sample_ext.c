...
static ebpf_base_map_provider_dispatch_table_t _sample_map_dispatch_table = {
    ...
    .post_process_map_find_element = _sample_map_find_entry,
    .pre_process_map_update_element = _sample_map_update_entry,
    .pre_process_map_delete_element = _sample_map_delete_entry};
