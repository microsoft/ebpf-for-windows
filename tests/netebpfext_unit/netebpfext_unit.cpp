...
TEST_CASE("sock_ops_listen_context", "[netebpfext]")
{
    ...
    // Test BPF_SOCK_OPS_LISTEN_CB context for IPv4
    ...
    REQUIRE(sock_ops_context->op == BPF_SOCK_OPS_LISTEN_CB);
    ...
    REQUIRE(output_data_size == 0);
    REQUIRE(output_context_size == sizeof(bpf_sock_ops_t));
    REQUIRE(output_context.op == BPF_SOCK_OPS_LISTEN_CB);
    ...
    // Test BPF_SOCK_OPS_LISTEN_CB context for IPv6
    ...
    input_context_v6.op = BPF_SOCK_OPS_LISTEN_CB;
