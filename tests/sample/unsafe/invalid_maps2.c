...
// clang -O2 -Werror -c invalid_maps2.c -o invalid_maps2.o
//
// For bpf code: clang -target bpf -O2 -Werror -c invalid_maps2.c -o invalid_maps2.o
...
// This invalid program creates a map with invalid map type.
...
#define BPF_MAP_TYPE_INVALID 100
...
SEC("maps")
// Dummy map with invalid map type.
struct bpf_map_def dummy_map3 = {
    .type = BPF_MAP_TYPE_INVALID,
    .key_size = sizeof(uint32_t),
    .value_size = sizeof(uint32_t),
    .max_entries = 10,
    .pinning = PIN_GLOBAL_NS};
