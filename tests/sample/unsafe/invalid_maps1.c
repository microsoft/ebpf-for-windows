...
// clang -O2 -Werror -c invalid_maps1.c -o invalid_maps1.o
//
// For bpf code: clang -target bpf -O2 -Werror -c invalid_maps1.c -o invalid_maps1.o
...
// This invalid program creates an outer map with invalid inner map id.
