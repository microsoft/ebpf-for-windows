...
static ebpf_base_map_provider_dispatch_table_t _test_sample_hash_map_dispatch_table = {
    ...
    .post_process_map_find_element = _test_sample_hash_map_find_entry,
    .pre_process_map_update_element = _test_sample_hash_map_update_entry,
    .pre_process_map_delete_element = _test_sample_hash_map_delete_entry};
  ...
  public:
    ...
    initialize(uint32_t map_type, bool object_map, bool register_crud_apis = true)
    {
        ...
        if (!register_crud_apis) {
            _test_sample_hash_map_provider_data.base_provider_table->post_process_map_find_element = nullptr;
            _test_sample_hash_map_provider_data.base_provider_table->pre_process_map_update_element = nullptr;
            _test_sample_hash_map_provider_data.base_provider_table->pre_process_map_delete_element = nullptr;
        } else {
            _test_sample_hash_map_provider_data.base_provider_table->post_process_map_find_element =
                _test_sample_hash_map_find_entry;
            _test_sample_hash_map_provider_data.base_provider_table->pre_process_map_update_element =
                _test_sample_hash_map_update_entry;
            _test_sample_hash_map_provider_data.base_provider_table->pre_process_map_delete_element =
                _test_sample_hash_map_delete_entry;
        }
