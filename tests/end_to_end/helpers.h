...
typedef class _single_instance_hook : public _hook_helper
{
  public:
    ...
    {
        attach_provider_data.header.version = EBPF_ATTACH_PROVIDER_DATA_VERSION_0;
...
static const ebpf_program_type_descriptor_t _mock_xdp_program_type_descriptor = {
    ...
    sizeof(ebpf_program_type_descriptor_t),
    "xdp",
...
static ebpf_program_data_t _ebpf_bind_program_data = {
    {EBPF_PROGRAM_DATA_VERSION_0, sizeof(ebpf_program_data_t)}, &_ebpf_bind_program_info, NULL};

// CGROUP_SOCK_ADDR.
static ebpf_program_data_t _ebpf_sock_addr_program_data = {
    {EBPF_PROGRAM_DATA_VERSION_0, sizeof(ebpf_program_data_t)}, &_ebpf_sock_addr_program_info, NULL};

// SOCK_OPS.
static ebpf_program_data_t _ebpf_sock_ops_program_data = {
    {EBPF_PROGRAM_DATA_VERSION_0, sizeof(ebpf_program_data_t)}, &_ebpf_sock_ops_program_info, NULL};
