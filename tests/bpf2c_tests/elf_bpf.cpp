...
DECLARE_TEST("cgroup_sock_addr_bind", _test_mode::Verify)
...
DECLARE_TEST("map_annotation_collision", _test_mode::Verify)
DECLARE_TEST("map_in_map_legacy_idx", _test_mode::Verify)
DECLARE_TEST("map_max_entries", _test_mode::Verify)
DECLARE_TEST("map_no_max_entries", _test_mode::Verify)
...
DECLARE_TEST("pidtgid_netebpf", _test_mode::Verify)
DECLARE_TEST("pidtgid_sample", _test_mode::Verify)
