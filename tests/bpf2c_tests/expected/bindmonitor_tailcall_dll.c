...
#line 152 "sample/bindmonitor_tailcall.c"
    r1 = IMMEDIATE(0);
    // EBPF_OP_STXW pc=2 dst=r10 src=r1 offset=-84 imm=0
...
#line 156 "sample/bindmonitor_tailcall.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JEQ_IMM pc=9 dst=r0 src=r0 offset=75 imm=0
...
#line 157 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_LDXW pc=10 dst=r2 src=r0 offset=0 imm=0
#line 157 "sample/bindmonitor_tailcall.c"
    READ_ONCE_32(r2, r0, OFFSET(0));
    // EBPF_OP_JEQ_IMM pc=11 dst=r2 src=r0 offset=73 imm=0
#line 157 "sample/bindmonitor_tailcall.c"
    if (r2 == IMMEDIATE(0)) {
#line 157 "sample/bindmonitor_tailcall.c"
        goto label_6;
...
#line 91 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JNE_IMM pc=32 dst=r1 src=r0 offset=51 imm=0
#line 91 "sample/bindmonitor_tailcall.c"
    if (r1 != IMMEDIATE(0)) {
#line 91 "sample/bindmonitor_tailcall.c"
        goto label_5;
...
#line 95 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JEQ_IMM pc=34 dst=r1 src=r0 offset=49 imm=0
#line 95 "sample/bindmonitor_tailcall.c"
    if (r1 == IMMEDIATE(0)) {
#line 95 "sample/bindmonitor_tailcall.c"
        goto label_5;
...
#line 95 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JEQ_IMM pc=36 dst=r1 src=r0 offset=47 imm=0
#line 95 "sample/bindmonitor_tailcall.c"
    if (r1 == IMMEDIATE(0)) {
#line 95 "sample/bindmonitor_tailcall.c"
        goto label_5;
...
#line 100 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JEQ_IMM pc=50 dst=r0 src=r0 offset=33 imm=0
...
#line 105 "sample/bindmonitor_tailcall.c"
    r0 = r7;
label_1:
    // EBPF_OP_LDXW pc=60 dst=r2 src=r0 offset=0 imm=0
#line 105 "sample/bindmonitor_tailcall.c"
    READ_ONCE_32(r2, r0, OFFSET(0));
    // EBPF_OP_LDXW pc=61 dst=r1 src=r6 offset=44 imm=0
#line 167 "sample/bindmonitor_tailcall.c"
    READ_ONCE_32(r1, r6, OFFSET(44));
    // EBPF_OP_JEQ_IMM pc=62 dst=r1 src=r0 offset=7 imm=2
#line 167 "sample/bindmonitor_tailcall.c"
    if (r1 == IMMEDIATE(2)) {
#line 167 "sample/bindmonitor_tailcall.c"
        goto label_2;
#line 167 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JNE_IMM pc=63 dst=r1 src=r0 offset=9 imm=0
#line 167 "sample/bindmonitor_tailcall.c"
    if (r1 != IMMEDIATE(0)) {
#line 167 "sample/bindmonitor_tailcall.c"
        goto label_3;
...
#line 169 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_JGE_REG pc=66 dst=r2 src=r3 offset=18 imm=0
#line 169 "sample/bindmonitor_tailcall.c"
    if (r2 >= r3) {
#line 169 "sample/bindmonitor_tailcall.c"
        goto label_6;
#line 169 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_ADD64_IMM pc=67 dst=r2 src=r0 offset=0 imm=1
#line 173 "sample/bindmonitor_tailcall.c"
    r2 += IMMEDIATE(1);
    // EBPF_OP_STXW pc=68 dst=r0 src=r2 offset=0 imm=0
#line 173 "sample/bindmonitor_tailcall.c"
    WRITE_ONCE_32(r0, (uint32_t)r2, OFFSET(0));
    // EBPF_OP_JA pc=69 dst=r0 src=r0 offset=14 imm=0
#line 173 "sample/bindmonitor_tailcall.c"
    goto label_5;
label_2:
    // EBPF_OP_JEQ_IMM pc=70 dst=r2 src=r0 offset=6 imm=0
...
#line 176 "sample/bindmonitor_tailcall.c"
    ...
    // EBPF_OP_ADD64_IMM pc=71 dst=r2 src=r0 offset=0 imm=-1
#line 177 "sample/bindmonitor_tailcall.c"
    r2 += IMMEDIATE(-1);
    // EBPF_OP_STXW pc=72 dst=r0 src=r2 offset=0 imm=0
#line 177 "sample/bindmonitor_tailcall.c"
    WRITE_ONCE_32(r0, (uint32_t)r2, OFFSET(0));
label_3:
    // EBPF_OP_LSH64_IMM pc=73 dst=r2 src=r0 offset=0 imm=32
#line 184 "sample/bindmonitor_tailcall.c"
    r2 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_RSH64_IMM pc=74 dst=r2 src=r0 offset=0 imm=32
#line 184 "sample/bindmonitor_tailcall.c"
    r2 >>= (IMMEDIATE(32) & 63);
    // EBPF_OP_MOV64_IMM pc=75 dst=r1 src=r0 offset=0 imm=1
#line 184 "sample/bindmonitor_tailcall.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JNE_IMM pc=76 dst=r2 src=r0 offset=8 imm=0
#line 184 "sample/bindmonitor_tailcall.c"
    if (r2 != IMMEDIATE(0)) {
#line 184 "sample/bindmonitor_tailcall.c"
        goto label_6;
...
label_4:
    // EBPF_OP_LDXDW pc=77 dst=r1 src=r6 offset=16 imm=0
#line 185 "sample/bindmonitor_tailcall.c"
    READ_ONCE_64(r1, r6, OFFSET(16));
    // EBPF_OP_STXDW pc=78 dst=r10 src=r1 offset=-80 imm=0
#line 185 "sample/bindmonitor_tailcall.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-80));
    // EBPF_OP_MOV64_REG pc=79 dst=r2 src=r10 offset=0 imm=0
#line 185 "sample/bindmonitor_tailcall.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=80 dst=r2 src=r0 offset=0 imm=-80
#line 185 "sample/bindmonitor_tailcall.c"
    r2 += IMMEDIATE(-80);
    // EBPF_OP_LDDW pc=81 dst=r1 src=r1 offset=0 imm=1
#line 186 "sample/bindmonitor_tailcall.c"
    r1 = POINTER(runtime_context->map_data[0].address);
    // EBPF_OP_CALL pc=83 dst=r0 src=r0 offset=0 imm=3
#line 186 "sample/bindmonitor_tailcall.c"
...
label_5:
    // EBPF_OP_MOV64_IMM pc=84 dst=r1 src=r0 offset=0 imm=1
#line 186 "sample/bindmonitor_tailcall.c"
    r1 = IMMEDIATE(1);
label_6:
    // EBPF_OP_MOV64_REG pc=85 dst=r0 src=r1 offset=0 imm=0
#line 190 "sample/bindmonitor_tailcall.c"
    r0 = r1;
    // EBPF_OP_EXIT pc=86 dst=r0 src=r0 offset=0 imm=0
#line 190 "sample/bindmonitor_tailcall.c"
    return r0;
#line 152 "sample/bindmonitor_tailcall.c"
}
