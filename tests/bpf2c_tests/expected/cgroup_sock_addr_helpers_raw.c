...
#line 54 "sample/cgroup_sock_addr_helpers.c"
{
#line 54 "sample/cgroup_sock_addr_helpers.c"
    // Prologue.
#line 54 "sample/cgroup_sock_addr_helpers.c"
...
#line 59 "sample/cgroup_sock_addr_helpers.c"
...
#line 64 "sample/cgroup_sock_addr_helpers.c"
    r6 = IMMEDIATE(0);
...
#line 68 "sample/cgroup_sock_addr_helpers.c"
...
#line 82 "sample/cgroup_sock_addr_helpers.c"
    r4 = IMMEDIATE(0);
...
#line 84 "sample/cgroup_sock_addr_helpers.c"
    return r0;
#line 54 "sample/cgroup_sock_addr_helpers.c"
}
#pragma code_seg(pop)
...
#line 221 "sample/cgroup_sock_addr_helpers.c"
    r3 = IMMEDIATE(32);
...
#line 231 "sample/cgroup_sock_addr_helpers.c"
    if (r0 == IMMEDIATE(0)) {
#line 231 "sample/cgroup_sock_addr_helpers.c"
        goto label_1;
#line 231 "sample/cgroup_sock_addr_helpers.c"
...
#line 234 "sample/cgroup_sock_addr_helpers.c"
    r2 += IMMEDIATE(-44);
...
#line 237 "sample/cgroup_sock_addr_helpers.c"
    r0 = r6;
...
#line 253 "sample/cgroup_sock_addr_helpers.c"
    WRITE_ONCE_64(r10, (uint64_t)r6, OFFSET(-16));
...
#line 254 "sample/cgroup_sock_addr_helpers.c"
    r3 = IMMEDIATE(32);
...
#line 265 "sample/cgroup_sock_addr_helpers.c"
    READ_ONCE_64(r1, r0, OFFSET(0));
...
#line 177 "sample/cgroup_sock_addr_helpers.c"
{
#line 177 "sample/cgroup_sock_addr_helpers.c"
    // Prologue.
#line 177 "sample/cgroup_sock_addr_helpers.c"
...
#line 185 "sample/cgroup_sock_addr_helpers.c"
    r6 = IMMEDIATE(0);
    // EBPF_OP_STXDW pc=9 dst=r10 src=r6 offset=-40 imm=0
#line 187 "sample/cgroup_sock_addr_helpers.c"
    WRITE_ONCE_64(r10, (uint64_t)r6, OFFSET(-40));
    // EBPF_OP_STXDW pc=10 dst=r10 src=r6 offset=-32 imm=0
#line 187 "sample/cgroup_sock_addr_helpers.c"
    WRITE_ONCE_64(r10, (uint64_t)r6, OFFSET(-32));
...
#line 201 "sample/cgroup_sock_addr_helpers.c"
    r2 += IMMEDIATE(-44);
...
#line 204 "sample/cgroup_sock_addr_helpers.c"
    r0 = r6;
...
label_2:
    // EBPF_OP_MOV64_REG pc=48 dst=r0 src=r6 offset=0 imm=0
#line 87 "sample/cgroup_sock_addr_helpers.c"
    r0 = r6;
    // EBPF_OP_EXIT pc=49 dst=r0 src=r0 offset=0 imm=0
#line 87 "sample/cgroup_sock_addr_helpers.c"
    return r0;
...
#line 95 "sample/cgroup_sock_addr_helpers.c"
{
#line 95 "sample/cgroup_sock_addr_helpers.c"
    // Prologue.
#line 95 "sample/cgroup_sock_addr_helpers.c"
...
#line 106 "sample/cgroup_sock_addr_helpers.c"
    READ_ONCE_32(r2, r1, OFFSET(24));
...
#line 110 "sample/cgroup_sock_addr_helpers.c"
    r3 = IMMEDIATE(32);
...
#line 122 "sample/cgroup_sock_addr_helpers.c"
    if (r0 == IMMEDIATE(0)) {
#line 122 "sample/cgroup_sock_addr_helpers.c"
        goto label_1;
#line 122 "sample/cgroup_sock_addr_helpers.c"
