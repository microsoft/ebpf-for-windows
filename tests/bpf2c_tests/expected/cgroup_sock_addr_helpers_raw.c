...
static GUID conditional_auth_v4_program_type_guid = {
    0x92ec8e39, 0xaeec, 0x11ec, {0x9a, 0x30, 0x18, 0x60, 0x24, 0x89, 0xbe, 0xee}};
static GUID conditional_auth_v4_attach_type_guid = {
    0x6076c13a, 0xf04f, 0x4ff8, {0x83, 0x80, 0x90, 0x85, 0x53, 0xf2, 0x22, 0x76}};
static uint16_t conditional_auth_v4_maps[] = {
    1,
};

#pragma code_seg(push, "cgroup~2")
static uint64_t
conditional_auth_v4(void* context, const program_runtime_context_t* runtime_context)
...
static program_entry_t _programs[] = {
    {
        ...
        "conditional_auth_v4",
        conditional_auth_v4_maps,
        1,
        conditional_auth_v4_helpers,
        3,
        42,
        &conditional_auth_v4_program_type_guid,
        &conditional_auth_v4_attach_type_guid,
    },
    {
        0,
        {1, 144, 144}, // Version header.
