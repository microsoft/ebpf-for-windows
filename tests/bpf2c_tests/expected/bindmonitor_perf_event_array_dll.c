...
#line 27 "sample/bindmonitor_perf_event_array.c"
    ...
    // EBPF_OP_JNE_IMM pc=1 dst=r2 src=r0 offset=9 imm=0
#line 27 "sample/bindmonitor_perf_event_array.c"
    if (r2 != IMMEDIATE(0)) {
#line 27 "sample/bindmonitor_perf_event_array.c"
        goto label_1;
...
#line 31 "sample/bindmonitor_perf_event_array.c"
    r5 -= r4;
    // EBPF_OP_LDDW pc=6 dst=r2 src=r1 offset=0 imm=1
#line 30 "sample/bindmonitor_perf_event_array.c"
    r2 = POINTER(runtime_context->map_data[0].address);
    // EBPF_OP_LDDW pc=8 dst=r3 src=r0 offset=0 imm=-1
#line 30 "sample/bindmonitor_perf_event_array.c"
    r3 = (uint64_t)4294967295;
    // EBPF_OP_CALL pc=10 dst=r0 src=r0 offset=0 imm=32
#line 30 "sample/bindmonitor_perf_event_array.c"
