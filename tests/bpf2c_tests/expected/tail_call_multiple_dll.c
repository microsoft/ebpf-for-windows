...
static program_entry_t _programs[] = {
    {
        ...
        .section_name = "sample_ext/0",
        .program_name = "callee0",
        .referenced_map_indices = callee0_maps,
        .referenced_map_count = 1,
        .helpers = callee0_helpers,
        .helper_count = 1,
        .bpf_instruction_count = 6,
        .program_type = &callee0_program_type_guid,
        .expected_attach_type = &callee0_attach_type_guid,
    ...
    },
    {
        ...
        .section_name = "sample_ext/1",
        .program_name = "callee1",
        .referenced_map_indices = NULL,
        .referenced_map_count = 0,
        .helpers = NULL,
        .helper_count = 0,
        .bpf_instruction_count = 2,
        .program_type = &callee1_program_type_guid,
        .expected_attach_type = &callee1_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        ...
        .program_name = "caller",
        .referenced_map_indices = caller_maps,
        .referenced_map_count = 1,
        .helpers = caller_helpers,
        .helper_count = 1,
        .bpf_instruction_count = 6,
        .program_type = &caller_program_type_guid,
        .expected_attach_type = &caller_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
