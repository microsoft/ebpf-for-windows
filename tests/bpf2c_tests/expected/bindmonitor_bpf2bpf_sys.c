...
#line 45 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-16)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=204
#line 45 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(204);
#line 45 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 53 "sample/bindmonitor_bpf2bpf.c"
    r1 += IMMEDIATE(16);
    // EBPF_OP_CALL pc=9 dst=r0 src=r1 offset=0 imm=32
#line 53 "sample/bindmonitor_bpf2bpf.c"
    r0 = BindMonitor_Callee1(r1, r2, r3, r4, r5, r10, context);
    //  pc=10 dst=r0 src=r0 offset=5 imm=1
#line 53 "sample/bindmonitor_bpf2bpf.c"
    if ((uint32_t)r0 != IMMEDIATE(1)) {
#line 53 "sample/bindmonitor_bpf2bpf.c"
        goto label_2;
#line 53 "sample/bindmonitor_bpf2bpf.c"
    }
...
#line 53 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_STXW pc=13 dst=r10 src=r1 offset=-4 imm=0
#line 54 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r1;
    // EBPF_OP_STXW pc=14 dst=r10 src=r1 offset=-36 imm=0
#line 54 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-36)) = (uint32_t)r1;
    // EBPF_OP_JA pc=15 dst=r0 src=r0 offset=24 imm=0
#line 54 "sample/bindmonitor_bpf2bpf.c"
    goto label_8;
label_2:
    // EBPF_OP_LDXB pc=16 dst=r1 src=r10 offset=-18 imm=0
#line 58 "sample/bindmonitor_bpf2bpf.c"
    r1 = *(uint8_t*)(uintptr_t)(r10 + OFFSET(-18));
    //  pc=17 dst=r1 src=r0 offset=4 imm=204
#line 58 "sample/bindmonitor_bpf2bpf.c"
    if ((uint32_t)r1 != IMMEDIATE(204)) {
#line 58 "sample/bindmonitor_bpf2bpf.c"
        goto label_4;
#line 58 "sample/bindmonitor_bpf2bpf.c"
    }
    // EBPF_OP_JA pc=18 dst=r0 src=r0 offset=0 imm=0
#line 58 "sample/bindmonitor_bpf2bpf.c"
    goto label_3;
label_3:
    // EBPF_OP_LDXB pc=19 dst=r1 src=r10 offset=-17 imm=0
#line 58 "sample/bindmonitor_bpf2bpf.c"
    r1 = *(uint8_t*)(uintptr_t)(r10 + OFFSET(-17));
    //  pc=20 dst=r1 src=r0 offset=6 imm=204
#line 58 "sample/bindmonitor_bpf2bpf.c"
    if ((uint32_t)r1 == IMMEDIATE(204)) {
#line 58 "sample/bindmonitor_bpf2bpf.c"
        goto label_5;
#line 58 "sample/bindmonitor_bpf2bpf.c"
    ...
    // EBPF_OP_JA pc=21 dst=r0 src=r0 offset=0 imm=0
#line 58 "sample/bindmonitor_bpf2bpf.c"
    goto label_4;
label_4:
    // EBPF_OP_MOV_IMM pc=22 dst=r1 src=r0 offset=0 imm=-1
#line 58 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(-1);
#line 58 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 59 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r1;
    // EBPF_OP_MOV_IMM pc=24 dst=r1 src=r0 offset=0 imm=1
#line 59 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(1);
#line 59 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_STXW pc=25 dst=r10 src=r1 offset=-36 imm=0
#line 59 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-36)) = (uint32_t)r1;
    // EBPF_OP_JA pc=26 dst=r0 src=r0 offset=13 imm=0
#line 59 "sample/bindmonitor_bpf2bpf.c"
    goto label_8;
label_5:
    // EBPF_OP_LDXDW pc=27 dst=r1 src=r10 offset=-32 imm=0
#line 62 "sample/bindmonitor_bpf2bpf.c"
    r1 = *(uint64_t*)(uintptr_t)(r10 + OFFSET(-32));
    // EBPF_OP_JNE_IMM pc=28 dst=r1 src=r0 offset=6 imm=1
#line 62 "sample/bindmonitor_bpf2bpf.c"
    if (r1 != IMMEDIATE(1)) {
#line 62 "sample/bindmonitor_bpf2bpf.c"
        goto label_7;
#line 62 "sample/bindmonitor_bpf2bpf.c"
    ...
    // EBPF_OP_JA pc=29 dst=r0 src=r0 offset=0 imm=0
#line 62 "sample/bindmonitor_bpf2bpf.c"
    goto label_6;
label_6:
    // EBPF_OP_MOV_IMM pc=30 dst=r1 src=r0 offset=0 imm=2
#line 62 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(2);
#line 62 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_STXW pc=31 dst=r10 src=r1 offset=-4 imm=0
#line 64 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r1;
    // EBPF_OP_MOV_IMM pc=32 dst=r1 src=r0 offset=0 imm=1
#line 64 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(1);
#line 64 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_STXW pc=33 dst=r10 src=r1 offset=-36 imm=0
#line 64 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-36)) = (uint32_t)r1;
    // EBPF_OP_JA pc=34 dst=r0 src=r0 offset=5 imm=0
#line 64 "sample/bindmonitor_bpf2bpf.c"
    goto label_8;
label_7:
    // EBPF_OP_MOV_IMM pc=35 dst=r1 src=r0 offset=0 imm=0
#line 64 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(0);
#line 64 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_STXW pc=36 dst=r10 src=r1 offset=-4 imm=0
#line 66 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r1;
    // EBPF_OP_MOV_IMM pc=37 dst=r1 src=r0 offset=0 imm=1
#line 66 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(1);
#line 66 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 66 "sample/bindmonitor_bpf2bpf.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-36)) = (uint32_t)r1;
    // EBPF_OP_JA pc=39 dst=r0 src=r0 offset=0 imm=0
#line 66 "sample/bindmonitor_bpf2bpf.c"
    goto label_8;
label_8:
    // EBPF_OP_LDXW pc=40 dst=r0 src=r10 offset=-4 imm=0
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=17
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(17);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=34
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(34);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=51
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(51);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=68
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(68);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=85
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(85);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=102
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(102);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 70 "sample/bindmonitor_bpf2bpf.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=1 dst=r1 src=r0 offset=0 imm=119
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 = IMMEDIATE(119);
#line 70 "sample/bindmonitor_bpf2bpf.c"
    r1 &= UINT32_MAX;
...
#line 77 "sample/bindmonitor_bpf2bpf.c"
    ...
    // EBPF_OP_MOV_IMM pc=6 dst=r0 src=r0 offset=0 imm=1
#line 77 "sample/bindmonitor_bpf2bpf.c"
    r0 = IMMEDIATE(1);
#line 77 "sample/bindmonitor_bpf2bpf.c"
    r0 &= UINT32_MAX;
...
#line 81 "sample/bindmonitor_bpf2bpf.c"
    ...
    // EBPF_OP_MOV_IMM pc=8 dst=r0 src=r0 offset=0 imm=0
#line 81 "sample/bindmonitor_bpf2bpf.c"
    r0 = IMMEDIATE(0);
#line 81 "sample/bindmonitor_bpf2bpf.c"
    r0 &= UINT32_MAX;
