...
static program_entry_t _programs[] = {
    {
        ...
        .function = entry_program1,
        .pe_section_name = "bind/1",
        .section_name = "bind/1",
        .program_name = "entry_program1",
        .referenced_map_indices = NULL,
        .referenced_map_count = 0,
        .helpers = entry_program1_helpers,
        .helper_count = 4,
        .bpf_instruction_count = 17,
        .program_type = &entry_program1_program_type_guid,
        .expected_attach_type = &entry_program1_attach_type_guid,
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = entry_program2,
        .pe_section_name = "bind/2",
        .section_name = "bind/2",
        .program_name = "entry_program2",
        .referenced_map_indices = NULL,
        .referenced_map_count = 0,
        .helpers = entry_program2_helpers,
        .helper_count = 4,
        .bpf_instruction_count = 13,
        .program_type = &entry_program2_program_type_guid,
        .expected_attach_type = &entry_program2_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = entry_program3,
        .pe_section_name = "bind/3",
        .section_name = "bind/3",
        .program_name = "entry_program3",
        .referenced_map_indices = entry_program3_maps,
        .referenced_map_count = 1,
        .helpers = entry_program3_helpers,
        .helper_count = 4,
        .bpf_instruction_count = 12,
        .program_type = &entry_program3_program_type_guid,
        .expected_attach_type = &entry_program3_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
