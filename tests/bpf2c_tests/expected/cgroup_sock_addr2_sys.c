...
#line 64 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=25 dst=r1 src=r0 offset=70 imm=6
#line 64 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 64 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 68 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=27 dst=r1 src=r0 offset=68 imm=2
#line 68 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(2))
#line 68 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 73 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(0);
    // EBPF_OP_JEQ_IMM pc=36 dst=r8 src=r0 offset=35 imm=0
...
#line 75 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-104)) = (uint64_t)r1;
    // EBPF_OP_MOV64_IMM pc=51 dst=r7 src=r0 offset=0 imm=0
#line 75 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(0);
    // EBPF_OP_STXB pc=52 dst=r10 src=r7 offset=-70 imm=0
#line 75 "sample/cgroup_sock_addr2.c"
...
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint64_t)r9;
    // EBPF_OP_STXDW pc=73 dst=r10 src=r9 offset=-96 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint64_t)r9;
    // EBPF_OP_STXDW pc=74 dst=r10 src=r9 offset=-104 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
...
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=76 dst=r0 src=r0 offset=0 imm=65536
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 44 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_MOV64_REG pc=77 dst=r8 src=r0 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r8 = r0;
    // EBPF_OP_STXDW pc=78 dst=r10 src=r8 offset=-96 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 47 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-104);
    // EBPF_OP_LDDW pc=92 dst=r1 src=r0 offset=0 imm=0
...
#line 101 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=19 dst=r1 src=r0 offset=86 imm=6
#line 101 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 101 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 105 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=21 dst=r2 src=r0 offset=84 imm=23
#line 105 "sample/cgroup_sock_addr2.c"
    if (r2 != IMMEDIATE(23))
#line 105 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 117 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(0);
    // EBPF_OP_JEQ_IMM pc=43 dst=r8 src=r0 offset=38 imm=0
#line 118 "sample/cgroup_sock_addr2.c"
    if (r8 == IMMEDIATE(0))
#line 118 "sample/cgroup_sock_addr2.c"
        goto label_2;
        // EBPF_OP_MOV64_IMM pc=44 dst=r1 src=r0 offset=0 imm=25973
#line 118 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(25973);
    // EBPF_OP_STXH pc=45 dst=r10 src=r1 offset=-72 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    *(uint16_t*)(uintptr_t)(r10 + OFFSET(-72)) = (uint16_t)r1;
    // EBPF_OP_LDDW pc=46 dst=r1 src=r0 offset=0 imm=2037544046
#line 119 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)7809653110685725806;
    // EBPF_OP_STXDW pc=48 dst=r10 src=r1 offset=-80 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-80)) = (uint64_t)r1;
    // EBPF_OP_LDDW pc=49 dst=r1 src=r0 offset=0 imm=1869770784
#line 119 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)7286957755258269728;
    // EBPF_OP_STXDW pc=51 dst=r10 src=r1 offset=-88 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint64_t)r1;
    // EBPF_OP_LDDW pc=52 dst=r1 src=r0 offset=0 imm=1853189958
#line 119 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)3924359741021974342;
    // EBPF_OP_STXDW pc=54 dst=r10 src=r1 offset=-96 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint64_t)r1;
    // EBPF_OP_MOV64_IMM pc=55 dst=r7 src=r0 offset=0 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(0);
    // EBPF_OP_STXB pc=56 dst=r10 src=r7 offset=-70 imm=0
#line 119 "sample/cgroup_sock_addr2.c"
    *(uint8_t*)(uintptr_t)(r10 + OFFSET(-70)) = (uint8_t)r7;
...
#line 122 "sample/cgroup_sock_addr2.c"
    r0 = (int64_t)r0 >> (uint32_t)(IMMEDIATE(32) & 63);
    // EBPF_OP_JSGT_REG pc=68 dst=r7 src=r0 offset=37 imm=0
#line 122 "sample/cgroup_sock_addr2.c"
    if ((int64_t)r7 > (int64_t)r0)
#line 122 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 122 "sample/cgroup_sock_addr2.c"
    r1 += IMMEDIATE(24);
    // EBPF_OP_LDXW pc=71 dst=r2 src=r8 offset=12 imm=0
...
#line 126 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(12)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=73 dst=r2 src=r8 offset=8 imm=0
#line 126 "sample/cgroup_sock_addr2.c"
...
#line 126 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(8)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=75 dst=r2 src=r8 offset=4 imm=0
#line 126 "sample/cgroup_sock_addr2.c"
...
#line 126 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(4)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=77 dst=r2 src=r8 offset=0 imm=0
#line 126 "sample/cgroup_sock_addr2.c"
...
#line 126 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(0)) = (uint32_t)r2;
    // EBPF_OP_LDXH pc=79 dst=r1 src=r8 offset=16 imm=0
#line 128 "sample/cgroup_sock_addr2.c"
    r1 = *(uint16_t*)(uintptr_t)(r8 + OFFSET(16));
    // EBPF_OP_STXH pc=80 dst=r6 src=r1 offset=40 imm=0
#line 128 "sample/cgroup_sock_addr2.c"
    *(uint16_t*)(uintptr_t)(r6 + OFFSET(40)) = (uint16_t)r1;
    // EBPF_OP_MOV64_IMM pc=81 dst=r7 src=r0 offset=0 imm=1
#line 128 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(1);
label_2:
    // EBPF_OP_STXDW pc=82 dst=r10 src=r9 offset=-80 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-80)) = (uint64_t)r9;
    // EBPF_OP_STXDW pc=83 dst=r10 src=r9 offset=-88 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint64_t)r9;
    // EBPF_OP_STXDW pc=84 dst=r10 src=r9 offset=-96 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint64_t)r9;
    // EBPF_OP_MOV64_REG pc=85 dst=r1 src=r6 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=86 dst=r0 src=r0 offset=0 imm=65536
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 44 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_MOV64_REG pc=87 dst=r8 src=r0 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r8 = r0;
    // EBPF_OP_STXDW pc=88 dst=r10 src=r8 offset=-88 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint64_t)r8;
    // EBPF_OP_MOV64_REG pc=89 dst=r1 src=r6 offset=0 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=90 dst=r0 src=r0 offset=0 imm=20
#line 45 "sample/cgroup_sock_addr2.c"
...
#line 45 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=91 dst=r10 src=r0 offset=-96 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint64_t)r0;
    // EBPF_OP_MOV64_REG pc=92 dst=r1 src=r6 offset=0 imm=0
#line 46 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=93 dst=r0 src=r0 offset=0 imm=21
#line 46 "sample/cgroup_sock_addr2.c"
...
#line 46 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXW pc=94 dst=r10 src=r0 offset=-80 imm=0
#line 46 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-80)) = (uint32_t)r0;
    // EBPF_OP_LDXH pc=95 dst=r1 src=r6 offset=20 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r1 = *(uint16_t*)(uintptr_t)(r6 + OFFSET(20));
    // EBPF_OP_STXDW pc=96 dst=r10 src=r8 offset=-8 imm=0
#line 49 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r8;
    // EBPF_OP_STXH pc=97 dst=r10 src=r1 offset=-76 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    *(uint16_t*)(uintptr_t)(r10 + OFFSET(-76)) = (uint16_t)r1;
    // EBPF_OP_MOV64_REG pc=98 dst=r2 src=r10 offset=0 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=99 dst=r2 src=r0 offset=0 imm=-8
#line 47 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-8);
    // EBPF_OP_MOV64_REG pc=100 dst=r3 src=r10 offset=0 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r3 = r10;
    // EBPF_OP_ADD64_IMM pc=101 dst=r3 src=r0 offset=0 imm=-96
#line 47 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-96);
    // EBPF_OP_LDDW pc=102 dst=r1 src=r0 offset=0 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    r1 = POINTER(_maps[1].address);
    // EBPF_OP_MOV64_IMM pc=104 dst=r4 src=r0 offset=0 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    r4 = IMMEDIATE(0);
    // EBPF_OP_CALL pc=105 dst=r0 src=r0 offset=0 imm=2
#line 50 "sample/cgroup_sock_addr2.c"
...
#line 50 "sample/cgroup_sock_addr2.c"
        return 0;
label_3:
    // EBPF_OP_MOV64_REG pc=106 dst=r0 src=r7 offset=0 imm=0
