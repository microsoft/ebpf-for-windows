...
static program_entry_t _programs[] = {
    {
        ...
        .program_name = "divide_by_zero",
        .referenced_map_indices = divide_by_zero_maps,
        .referenced_map_count = 1,
        .helpers = divide_by_zero_helpers,
        .helper_count = 1,
        .bpf_instruction_count = 13,
        .program_type = &divide_by_zero_program_type_guid,
        .expected_attach_type = &divide_by_zero_attach_type_guid,
