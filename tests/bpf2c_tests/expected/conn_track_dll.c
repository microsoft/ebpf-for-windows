...
#define metadata_table conn_track##_metadata_table
...
{
#line 91 "ebpf-for-windows/tests/sample/conn_track.c"
    // Prologue
#line 91 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 95 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 109 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 72 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 51 "ebpf-for-windows/tests/sample/conn_track.c"
    if (r8 != IMMEDIATE(2))
#line 51 "ebpf-for-windows/tests/sample/conn_track.c"
        goto label_3;
        // EBPF_OP_LDXW pc=18 dst=r2 src=r1 offset=8 imm=0
#line 52 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 53 "ebpf-for-windows/tests/sample/conn_track.c"
    r4 = *(uint32_t*)(uintptr_t)(r1 + OFFSET(24));
    // EBPF_OP_LDXW pc=21 dst=r2 src=r1 offset=28 imm=0
#line 54 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 60 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 63 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 61 "ebpf-for-windows/tests/sample/conn_track.c"
    r4 = *(uint32_t*)(uintptr_t)(r1 + OFFSET(24));
...
#line 76 "ebpf-for-windows/tests/sample/conn_track.c"
    if (r6 == IMMEDIATE(0))
#line 76 "ebpf-for-windows/tests/sample/conn_track.c"
        goto label_5;
        // EBPF_OP_JNE_IMM pc=123 dst=r8 src=r0 offset=44 imm=2
#line 32 "ebpf-for-windows/tests/sample/conn_track.c"
    if (r8 != IMMEDIATE(2))
#line 32 "ebpf-for-windows/tests/sample/conn_track.c"
        goto label_6;
...
#line 34 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 80 "ebpf-for-windows/tests/sample/conn_track.c"
    r2 += IMMEDIATE(-48);
...
#line 81 "ebpf-for-windows/tests/sample/conn_track.c"
    if (r6 == IMMEDIATE(0))
#line 81 "ebpf-for-windows/tests/sample/conn_track.c"
        goto label_10;
...
#line 36 "ebpf-for-windows/tests/sample/conn_track.c"
    *(uint16_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint16_t)r1;
...
#line 41 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 78 "ebpf-for-windows/tests/sample/conn_track.c"
    r1 = POINTER(_maps[0].address);
...
#line 43 "ebpf-for-windows/tests/sample/conn_track.c"
    *(uint8_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint8_t)r1;
...
#line 83 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 84 "ebpf-for-windows/tests/sample/conn_track.c"
...
#line 111 "ebpf-for-windows/tests/sample/conn_track.c"
    r0 = IMMEDIATE(0);
