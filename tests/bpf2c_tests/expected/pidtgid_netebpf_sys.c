...
// This file was generated from pidtgid_netebpf.o
...
#define metadata_table pidtgid_netebpf##_metadata_table
...
static helper_function_entry_t sock_addr_program_helpers[] = {
    {
...
static GUID sock_addr_program_program_type_guid = {
    0x92ec8e39, 0xaeec, 0x11ec, {0x9a, 0x30, 0x18, 0x60, 0x24, 0x89, 0xbe, 0xee}};
static GUID sock_addr_program_attach_type_guid = {
    0x0d7ce21a, 0x7773, 0x405c, {0x93, 0xb6, 0xd5, 0xbf, 0xb9, 0x2e, 0x74, 0xbc}};
static uint16_t sock_addr_program_maps[] = {
    0,
};

#pragma code_seg(push, "cgroup~1")
static uint64_t
sock_addr_program(void* context, const program_runtime_context_t* runtime_context)
#line 28 "sample/pidtgid_netebpf.c"
{
#line 28 "sample/pidtgid_netebpf.c"
    // Prologue.
#line 28 "sample/pidtgid_netebpf.c"
...
#line 28 "sample/pidtgid_netebpf.c"
    ...
    // EBPF_OP_JNE_IMM pc=1 dst=r1 src=r0 offset=12 imm=48955
#line 28 "sample/pidtgid_netebpf.c"
...
#line 21 "sample/pidtgid_netebpf.c"
...
#line 31 "sample/pidtgid_netebpf.c"
    r0 = IMMEDIATE(1);
...
static helper_function_entry_t sock_ops_program_helpers[] = {
    {
     {1, 40, 40}, // Version header.
     19,
     "helper_id_19",
...
static GUID sock_ops_program_program_type_guid = {
    0x43fb224d, 0x68f8, 0x46d6, {0xaa, 0x3f, 0xc8, 0x56, 0x51, 0x8c, 0xbb, 0x32}};
static GUID sock_ops_program_attach_type_guid = {
    0x837d02cd, 0x3251, 0x4632, {0x8d, 0x94, 0x60, 0xd3, 0xb4, 0x57, 0x69, 0xf2}};
static uint16_t sock_ops_program_maps[] = {
    0,
};

#pragma code_seg(push, "sockops")
static uint64_t
sock_ops_program(void* context, const program_runtime_context_t* runtime_context)
#line 39 "sample/pidtgid_netebpf.c"
{
#line 39 "sample/pidtgid_netebpf.c"
    // Prologue.
#line 39 "sample/pidtgid_netebpf.c"
...
#line 39 "sample/pidtgid_netebpf.c"
    ...
    // EBPF_OP_JEQ_IMM pc=1 dst=r2 src=r0 offset=2 imm=48955
#line 39 "sample/pidtgid_netebpf.c"
    if (r2 == IMMEDIATE(48955)) {
#line 39 "sample/pidtgid_netebpf.c"
        goto label_1;
#line 39 "sample/pidtgid_netebpf.c"
    }
    // EBPF_OP_LDXW pc=2 dst=r1 src=r1 offset=44 imm=0
#line 39 "sample/pidtgid_netebpf.c"
    READ_ONCE_32(r1, r1, OFFSET(44));
    // EBPF_OP_JNE_IMM pc=3 dst=r1 src=r0 offset=12 imm=48955
#line 39 "sample/pidtgid_netebpf.c"
    if (r1 != IMMEDIATE(48955)) {
#line 39 "sample/pidtgid_netebpf.c"
        goto label_2;
...
label_1:
    // EBPF_OP_MOV64_IMM pc=4 dst=r1 src=r0 offset=0 imm=0
#line 39 "sample/pidtgid_netebpf.c"
    r1 = IMMEDIATE(0);
...
#line 20 "sample/pidtgid_netebpf.c"
    PreFetchCacheLine(PF_TEMPORAL_LEVEL_1, runtime_context->map_data[0].address);
    // EBPF_OP_STXDW pc=7 dst=r10 src=r0 offset=-16 imm=0
#line 20 "sample/pidtgid_netebpf.c"
    WRITE_ONCE_64(r10, (uint64_t)r0, OFFSET(-16));
    // EBPF_OP_MOV64_REG pc=8 dst=r2 src=r10 offset=0 imm=0
#line 20 "sample/pidtgid_netebpf.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=9 dst=r2 src=r0 offset=0 imm=-4
#line 20 "sample/pidtgid_netebpf.c"
    r2 += IMMEDIATE(-4);
...
#line 42 "sample/pidtgid_netebpf.c"
    r0 = IMMEDIATE(0);
...
static program_entry_t _programs[] = {
    {
        ...
        "cgroup/bind4",
        "sock_addr_program",
        sock_addr_program_maps,
        1,
        sock_addr_program_helpers,
        2,
        16,
        &sock_addr_program_program_type_guid,
        &sock_addr_program_attach_type_guid,
    },
    {
        0,
        {1, 154, 160}, // Version header.
        ...
        "sockops",
        "sock_ops_program",
        sock_ops_program_maps,
        1,
        sock_ops_program_helpers,
        2,
        18,
        &sock_ops_program_program_type_guid,
        &sock_ops_program_attach_type_guid,
    },
};
#pragma data_seg(pop)
...
metadata_table_t pidtgid_netebpf_metadata_table = {
