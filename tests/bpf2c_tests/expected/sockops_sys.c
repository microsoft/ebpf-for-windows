...
static program_entry_t _programs[] = {
    {
        ...
        .program_name = "connection_monitor",
        .referenced_map_indices = connection_monitor_maps,
        .referenced_map_count = 2,
        .helpers = connection_monitor_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 179,
        .program_type = &connection_monitor_program_type_guid,
        .expected_attach_type = &connection_monitor_attach_type_guid,
