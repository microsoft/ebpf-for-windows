...
#line 60 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=13 dst=r1 src=r0 offset=70 imm=6
#line 60 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 60 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
#line 64 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=15 dst=r1 src=r0 offset=68 imm=2
#line 64 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(2))
#line 64 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
#line 42 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=56 dst=r0 src=r0 offset=0 imm=19
#line 42 "sample/cgroup_sock_addr2.c"
...
#line 42 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=57 dst=r10 src=r0 offset=-64 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64)) = (uint64_t)r0;
    // EBPF_OP_MOV64_REG pc=58 dst=r8 src=r10 offset=0 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    r8 = r10;
    // EBPF_OP_ADD64_IMM pc=59 dst=r8 src=r0 offset=0 imm=-72
#line 42 "sample/cgroup_sock_addr2.c"
    r8 += IMMEDIATE(-72);
...
#line 43 "sample/cgroup_sock_addr2.c"
    r2 = r8;
    // EBPF_OP_MOV64_IMM pc=62 dst=r3 src=r0 offset=0 imm=8
#line 43 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(8);
    // EBPF_OP_CALL pc=63 dst=r0 src=r0 offset=0 imm=20
#line 43 "sample/cgroup_sock_addr2.c"
...
#line 41 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=65 dst=r2 src=r0 offset=0 imm=-56
#line 41 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-56);
    // EBPF_OP_MOV64_REG pc=66 dst=r1 src=r6 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_MOV64_IMM pc=67 dst=r3 src=r0 offset=0 imm=4
#line 44 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(4);
    // EBPF_OP_CALL pc=68 dst=r0 src=r0 offset=0 imm=21
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 44 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_LDXDW pc=69 dst=r1 src=r10 offset=-64 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r1 = *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64));
    // EBPF_OP_STXDW pc=70 dst=r10 src=r1 offset=-8 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_LSH64_IMM pc=71 dst=r0 src=r0 offset=0 imm=32
#line 44 "sample/cgroup_sock_addr2.c"
    r0 <<= IMMEDIATE(32);
    // EBPF_OP_RSH64_IMM pc=72 dst=r0 src=r0 offset=0 imm=32
#line 44 "sample/cgroup_sock_addr2.c"
    r0 >>= IMMEDIATE(32);
    // EBPF_OP_MOV64_IMM pc=73 dst=r1 src=r0 offset=0 imm=1
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JEQ_IMM pc=74 dst=r0 src=r0 offset=1 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    if (r0 == IMMEDIATE(0))
#line 45 "sample/cgroup_sock_addr2.c"
        goto label_3;
        // EBPF_OP_MOV64_IMM pc=75 dst=r1 src=r0 offset=0 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(0);
label_3:
    // EBPF_OP_STXW pc=76 dst=r10 src=r1 offset=-52 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-52)) = (uint32_t)r1;
    // EBPF_OP_MOV64_REG pc=77 dst=r2 src=r10 offset=0 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=78 dst=r2 src=r0 offset=0 imm=-8
#line 45 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-8);
    // EBPF_OP_LDDW pc=79 dst=r1 src=r0 offset=0 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    r1 = POINTER(_maps[1].address);
    // EBPF_OP_MOV64_REG pc=81 dst=r3 src=r8 offset=0 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    r3 = r8;
...
#line 89 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=7 dst=r1 src=r0 offset=86 imm=6
#line 89 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 89 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
#line 93 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=9 dst=r2 src=r0 offset=84 imm=23
#line 93 "sample/cgroup_sock_addr2.c"
    if (r2 != IMMEDIATE(23))
#line 93 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
#line 42 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=66 dst=r0 src=r0 offset=0 imm=19
#line 42 "sample/cgroup_sock_addr2.c"
...
#line 42 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=67 dst=r10 src=r0 offset=-56 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-56)) = (uint64_t)r0;
    // EBPF_OP_MOV64_REG pc=68 dst=r8 src=r10 offset=0 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    r8 = r10;
    // EBPF_OP_ADD64_IMM pc=69 dst=r8 src=r0 offset=0 imm=-64
#line 42 "sample/cgroup_sock_addr2.c"
    r8 += IMMEDIATE(-64);
    // EBPF_OP_MOV64_REG pc=70 dst=r1 src=r6 offset=0 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_MOV64_REG pc=71 dst=r2 src=r8 offset=0 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    r2 = r8;
    // EBPF_OP_MOV64_IMM pc=72 dst=r3 src=r0 offset=0 imm=8
#line 43 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(8);
    // EBPF_OP_CALL pc=73 dst=r0 src=r0 offset=0 imm=20
#line 43 "sample/cgroup_sock_addr2.c"
...
#line 43 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_MOV64_REG pc=74 dst=r2 src=r10 offset=0 imm=0
#line 41 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=75 dst=r2 src=r0 offset=0 imm=-48
#line 41 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-48);
    // EBPF_OP_MOV64_REG pc=76 dst=r1 src=r6 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_MOV64_IMM pc=77 dst=r3 src=r0 offset=0 imm=4
#line 44 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(4);
    // EBPF_OP_CALL pc=78 dst=r0 src=r0 offset=0 imm=21
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 44 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_LDXDW pc=79 dst=r1 src=r10 offset=-56 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r1 = *(uint64_t*)(uintptr_t)(r10 + OFFSET(-56));
    // EBPF_OP_STXDW pc=80 dst=r10 src=r1 offset=-8 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r1;
    // EBPF_OP_LSH64_IMM pc=81 dst=r0 src=r0 offset=0 imm=32
#line 44 "sample/cgroup_sock_addr2.c"
    r0 <<= IMMEDIATE(32);
    // EBPF_OP_RSH64_IMM pc=82 dst=r0 src=r0 offset=0 imm=32
#line 44 "sample/cgroup_sock_addr2.c"
    r0 >>= IMMEDIATE(32);
    // EBPF_OP_MOV64_IMM pc=83 dst=r1 src=r0 offset=0 imm=1
#line 44 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JEQ_IMM pc=84 dst=r0 src=r0 offset=1 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    if (r0 == IMMEDIATE(0))
#line 45 "sample/cgroup_sock_addr2.c"
        goto label_3;
        // EBPF_OP_MOV64_IMM pc=85 dst=r1 src=r0 offset=0 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(0);
label_3:
    // EBPF_OP_STXW pc=86 dst=r10 src=r1 offset=-44 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
...
#line 48 "sample/cgroup_sock_addr2.c"
    r1 = POINTER(_maps[1].address);
    // EBPF_OP_MOV64_REG pc=91 dst=r3 src=r8 offset=0 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    r3 = r8;
    // EBPF_OP_MOV64_IMM pc=92 dst=r4 src=r0 offset=0 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    r4 = IMMEDIATE(0);
    // EBPF_OP_CALL pc=93 dst=r0 src=r0 offset=0 imm=2
#line 48 "sample/cgroup_sock_addr2.c"
...
#line 48 "sample/cgroup_sock_addr2.c"
        return 0;
label_4:
    // EBPF_OP_MOV64_REG pc=94 dst=r0 src=r7 offset=0 imm=0
#line 130 "sample/cgroup_sock_addr2.c"
    r0 = r7;
    // EBPF_OP_EXIT pc=95 dst=r0 src=r0 offset=0 imm=0
#line 130 "sample/cgroup_sock_addr2.c"
    return r0;
#line 130 "sample/cgroup_sock_addr2.c"
}
