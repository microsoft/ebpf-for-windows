...
#line 59 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=13 dst=r1 src=r0 offset=54 imm=6
#line 59 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 59 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 63 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=15 dst=r1 src=r0 offset=52 imm=2
#line 63 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(2))
#line 63 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 72 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(1);
label_2:
    // EBPF_OP_STXW pc=52 dst=r10 src=r9 offset=-4 imm=0
#line 40 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r9;
    // EBPF_OP_STXDW pc=53 dst=r10 src=r9 offset=-56 imm=0
#line 41 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-56)) = (uint64_t)r9;
    // EBPF_OP_MOV64_REG pc=54 dst=r1 src=r6 offset=0 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=55 dst=r0 src=r0 offset=0 imm=20
#line 42 "sample/cgroup_sock_addr2.c"
...
#line 42 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=56 dst=r10 src=r0 offset=-64 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64)) = (uint64_t)r0;
    // EBPF_OP_MOV64_REG pc=57 dst=r1 src=r6 offset=0 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=58 dst=r0 src=r0 offset=0 imm=21
#line 43 "sample/cgroup_sock_addr2.c"
...
#line 43 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=59 dst=r10 src=r0 offset=-72 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
...
#line 43 "sample/cgroup_sock_addr2.c"
    r3 = r10;
    // EBPF_OP_ADD64_IMM pc=63 dst=r3 src=r0 offset=0 imm=-72
#line 43 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-72);
...
#line 47 "sample/cgroup_sock_addr2.c"
        return 0;
label_3:
    // EBPF_OP_MOV64_REG pc=68 dst=r0 src=r7 offset=0 imm=0
#line 122 "sample/cgroup_sock_addr2.c"
    r0 = r7;
    // EBPF_OP_EXIT pc=69 dst=r0 src=r0 offset=0 imm=0
#line 122 "sample/cgroup_sock_addr2.c"
    return r0;
#line 122 "sample/cgroup_sock_addr2.c"
}
...
#line 88 "sample/cgroup_sock_addr2.c"
        goto label_1;
        // EBPF_OP_JNE_IMM pc=7 dst=r1 src=r0 offset=70 imm=6
#line 88 "sample/cgroup_sock_addr2.c"
    if (r1 != IMMEDIATE(6))
#line 88 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 92 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_JNE_IMM pc=9 dst=r2 src=r0 offset=68 imm=23
#line 92 "sample/cgroup_sock_addr2.c"
    if (r2 != IMMEDIATE(23))
#line 92 "sample/cgroup_sock_addr2.c"
        goto label_3;
...
#line 108 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(1);
label_2:
    // EBPF_OP_STXW pc=62 dst=r10 src=r9 offset=-4 imm=0
#line 40 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-4)) = (uint32_t)r9;
    // EBPF_OP_STXDW pc=63 dst=r10 src=r9 offset=-48 imm=0
#line 41 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-48)) = (uint64_t)r9;
    // EBPF_OP_MOV64_REG pc=64 dst=r1 src=r6 offset=0 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=65 dst=r0 src=r0 offset=0 imm=20
#line 42 "sample/cgroup_sock_addr2.c"
...
#line 42 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=66 dst=r10 src=r0 offset=-56 imm=0
#line 42 "sample/cgroup_sock_addr2.c"
...
#line 43 "sample/cgroup_sock_addr2.c"
        return 0;
        // EBPF_OP_STXDW pc=69 dst=r10 src=r0 offset=-64 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64)) = (uint64_t)r0;
    // EBPF_OP_MOV64_REG pc=70 dst=r2 src=r10 offset=0 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=71 dst=r2 src=r0 offset=0 imm=-4
#line 43 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-4);
    // EBPF_OP_MOV64_REG pc=72 dst=r3 src=r10 offset=0 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    r3 = r10;
    // EBPF_OP_ADD64_IMM pc=73 dst=r3 src=r0 offset=0 imm=-64
#line 43 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-64);
