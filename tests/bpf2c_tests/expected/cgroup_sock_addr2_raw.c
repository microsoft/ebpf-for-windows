...
#line 58 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-16)) = (uint32_t)r1;
    // EBPF_OP_STXW pc=3 dst=r10 src=r1 offset=-20 imm=0
#line 58 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-20)) = (uint32_t)r1;
    // EBPF_OP_STXW pc=4 dst=r10 src=r1 offset=-24 imm=0
#line 58 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-24)) = (uint32_t)r1;
    // EBPF_OP_STXW pc=5 dst=r10 src=r1 offset=-28 imm=0
#line 58 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-28)) = (uint32_t)r1;
    // EBPF_OP_MOV_IMM pc=6 dst=r1 src=r0 offset=0 imm=25959
#line 58 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(25959);
#line 58 "sample/cgroup_sock_addr2.c"
    r1 &= UINT32_MAX;
...
#line 59 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64)) = (uint64_t)r1;
    // EBPF_OP_MOV_IMM pc=17 dst=r7 src=r0 offset=0 imm=0
#line 59 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(0);
#line 59 "sample/cgroup_sock_addr2.c"
    r7 &= UINT32_MAX;
...
#line 59 "sample/cgroup_sock_addr2.c"
    *(uint8_t*)(uintptr_t)(r10 + OFFSET(-38)) = (uint8_t)r7;
    // EBPF_OP_LDXW pc=19 dst=r1 src=r6 offset=44 imm=0
#line 61 "sample/cgroup_sock_addr2.c"
    r1 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(44));
    //  pc=20 dst=r1 src=r0 offset=1 imm=17
#line 61 "sample/cgroup_sock_addr2.c"
...
#line 61 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=21 dst=r1 src=r0 offset=73 imm=6
#line 61 "sample/cgroup_sock_addr2.c"
...
#line 61 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=23 dst=r2 src=r0 offset=71 imm=2
#line 61 "sample/cgroup_sock_addr2.c"
...
#line 70 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_MOV64_REG pc=34 dst=r8 src=r0 offset=0 imm=0
#line 70 "sample/cgroup_sock_addr2.c"
    r8 = r0;
    // EBPF_OP_JEQ_IMM pc=35 dst=r8 src=r0 offset=34 imm=0
...
#line 72 "sample/cgroup_sock_addr2.c"
    *(uint8_t*)(uintptr_t)(r10 + OFFSET(-70)) = (uint8_t)r7;
    // EBPF_OP_MOV_IMM pc=37 dst=r1 src=r0 offset=0 imm=29989
#line 72 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(29989);
#line 72 "sample/cgroup_sock_addr2.c"
    r1 &= UINT32_MAX;
...
#line 72 "sample/cgroup_sock_addr2.c"
    r1 += IMMEDIATE(-104);
    // EBPF_OP_MOV_IMM pc=55 dst=r2 src=r0 offset=0 imm=35
#line 72 "sample/cgroup_sock_addr2.c"
    r2 = IMMEDIATE(35);
#line 72 "sample/cgroup_sock_addr2.c"
    r2 &= UINT32_MAX;
...
#line 78 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=58 dst=r1 src=r0 offset=6 imm=3
#line 78 "sample/cgroup_sock_addr2.c"
...
#line 79 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_MOV_IMM pc=62 dst=r3 src=r0 offset=0 imm=27
#line 79 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(27);
#line 79 "sample/cgroup_sock_addr2.c"
    r3 &= UINT32_MAX;
...
#line 79 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=64 dst=r0 src=r0 offset=30 imm=0
#line 79 "sample/cgroup_sock_addr2.c"
...
#line 84 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXW pc=66 dst=r6 src=r1 offset=24 imm=0
#line 84 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r6 + OFFSET(24)) = (uint32_t)r1;
    // EBPF_OP_LDXH pc=67 dst=r1 src=r8 offset=16 imm=0
#line 85 "sample/cgroup_sock_addr2.c"
    r1 = *(uint16_t*)(uintptr_t)(r8 + OFFSET(16));
    // EBPF_OP_STXH pc=68 dst=r6 src=r1 offset=40 imm=0
#line 85 "sample/cgroup_sock_addr2.c"
    *(uint16_t*)(uintptr_t)(r6 + OFFSET(40)) = (uint16_t)r1;
    // EBPF_OP_MOV_IMM pc=69 dst=r7 src=r0 offset=0 imm=1
#line 85 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(1);
#line 85 "sample/cgroup_sock_addr2.c"
    r7 &= UINT32_MAX;
label_3:
    // EBPF_OP_MOV64_IMM pc=70 dst=r1 src=r0 offset=0 imm=0
#line 85 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(0);
    // EBPF_OP_STXDW pc=71 dst=r10 src=r1 offset=-88 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint64_t)r1;
    // EBPF_OP_CALL pc=72 dst=r0 src=r0 offset=0 imm=19
...
#line 44 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_MOV64_REG pc=73 dst=r8 src=r0 offset=0 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    r8 = r0;
    // EBPF_OP_STXDW pc=74 dst=r10 src=r8 offset=-96 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-96)) = (uint64_t)r8;
    // EBPF_OP_MOV64_REG pc=75 dst=r1 src=r6 offset=0 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=76 dst=r0 src=r0 offset=0 imm=20
#line 45 "sample/cgroup_sock_addr2.c"
...
#line 45 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXDW pc=77 dst=r10 src=r0 offset=-104 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
...
#line 46 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=79 dst=r0 src=r0 offset=0 imm=21
#line 46 "sample/cgroup_sock_addr2.c"
...
#line 46 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXW pc=80 dst=r10 src=r0 offset=-88 imm=0
#line 46 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-88)) = (uint32_t)r0;
    // EBPF_OP_LDXH pc=81 dst=r1 src=r6 offset=20 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
    r1 = *(uint16_t*)(uintptr_t)(r6 + OFFSET(20));
    // EBPF_OP_STXH pc=82 dst=r10 src=r1 offset=-84 imm=0
#line 47 "sample/cgroup_sock_addr2.c"
...
#line 48 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_CALL pc=84 dst=r0 src=r0 offset=0 imm=26
#line 48 "sample/cgroup_sock_addr2.c"
...
#line 48 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXDW pc=85 dst=r10 src=r0 offset=-80 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-80)) = (uint64_t)r0;
    // EBPF_OP_STXDW pc=86 dst=r10 src=r8 offset=-8 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r8;
    // EBPF_OP_MOV64_REG pc=87 dst=r2 src=r10 offset=0 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=88 dst=r2 src=r0 offset=0 imm=-8
#line 50 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-8);
    // EBPF_OP_MOV64_REG pc=89 dst=r3 src=r10 offset=0 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    r3 = r10;
    // EBPF_OP_ADD64_IMM pc=90 dst=r3 src=r0 offset=0 imm=-104
#line 50 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-104);
    // EBPF_OP_LDDW pc=91 dst=r1 src=r1 offset=0 imm=2
#line 51 "sample/cgroup_sock_addr2.c"
    r1 = POINTER(runtime_context->map_data[1].address);
    // EBPF_OP_MOV64_IMM pc=93 dst=r4 src=r0 offset=0 imm=0
#line 51 "sample/cgroup_sock_addr2.c"
    r4 = IMMEDIATE(0);
    // EBPF_OP_CALL pc=94 dst=r0 src=r0 offset=0 imm=2
#line 51 "sample/cgroup_sock_addr2.c"
...
label_4:
    // EBPF_OP_MOV_REG pc=95 dst=r0 src=r7 offset=0 imm=0
#line 142 "sample/cgroup_sock_addr2.c"
    r0 = r7;
#line 142 "sample/cgroup_sock_addr2.c"
    r0 &= UINT32_MAX;
    // EBPF_OP_EXIT pc=96 dst=r0 src=r0 offset=0 imm=0
#line 142 "sample/cgroup_sock_addr2.c"
    return r0;
#line 140 "sample/cgroup_sock_addr2.c"
}
...
#line 99 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-48)) = (uint32_t)r7;
    // EBPF_OP_MOV_IMM pc=3 dst=r1 src=r0 offset=0 imm=25959
#line 99 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(25959);
#line 99 "sample/cgroup_sock_addr2.c"
    r1 &= UINT32_MAX;
...
#line 102 "sample/cgroup_sock_addr2.c"
    r1 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(44));
    //  pc=16 dst=r1 src=r0 offset=1 imm=17
#line 102 "sample/cgroup_sock_addr2.c"
    if ((uint32_t)r1 == IMMEDIATE(17)) {
#line 102 "sample/cgroup_sock_addr2.c"
        goto label_1;
#line 102 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=17 dst=r1 src=r0 offset=84 imm=6
#line 102 "sample/cgroup_sock_addr2.c"
    if ((uint32_t)r1 != IMMEDIATE(6)) {
#line 102 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
#line 102 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(0));
    //  pc=19 dst=r2 src=r0 offset=82 imm=23
#line 102 "sample/cgroup_sock_addr2.c"
...
#line 102 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_LDXW pc=20 dst=r2 src=r6 offset=32 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(32));
    // EBPF_OP_LDXW pc=21 dst=r3 src=r6 offset=36 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r3 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(36));
    // EBPF_OP_LSH64_IMM pc=22 dst=r3 src=r0 offset=0 imm=32
#line 109 "sample/cgroup_sock_addr2.c"
    r3 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_OR64_REG pc=23 dst=r3 src=r2 offset=0 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r3 |= r2;
    // EBPF_OP_STXDW pc=24 dst=r10 src=r3 offset=-56 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-56)) = (uint64_t)r3;
    // EBPF_OP_LDXW pc=25 dst=r2 src=r6 offset=24 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(24));
    // EBPF_OP_LDXW pc=26 dst=r3 src=r6 offset=28 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r3 = *(uint32_t*)(uintptr_t)(r6 + OFFSET(28));
    // EBPF_OP_LSH64_IMM pc=27 dst=r3 src=r0 offset=0 imm=32
#line 109 "sample/cgroup_sock_addr2.c"
    r3 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_OR64_REG pc=28 dst=r3 src=r2 offset=0 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
    r3 |= r2;
    // EBPF_OP_STXDW pc=29 dst=r10 src=r3 offset=-64 imm=0
#line 109 "sample/cgroup_sock_addr2.c"
...
#line 115 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXB pc=40 dst=r10 src=r7 offset=-14 imm=0
#line 116 "sample/cgroup_sock_addr2.c"
    *(uint8_t*)(uintptr_t)(r10 + OFFSET(-14)) = (uint8_t)r7;
    // EBPF_OP_MOV_IMM pc=41 dst=r1 src=r0 offset=0 imm=25973
#line 116 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(25973);
#line 116 "sample/cgroup_sock_addr2.c"
    r1 &= UINT32_MAX;
...
#line 116 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)7809653110685725806;
    // EBPF_OP_STXDW pc=45 dst=r10 src=r1 offset=-24 imm=0
#line 116 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-24)) = (uint64_t)r1;
    // EBPF_OP_LDDW pc=46 dst=r1 src=r0 offset=0 imm=1869770784
#line 116 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)7286957755258269728;
    // EBPF_OP_STXDW pc=48 dst=r10 src=r1 offset=-32 imm=0
#line 116 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-32)) = (uint64_t)r1;
    // EBPF_OP_LDDW pc=49 dst=r1 src=r0 offset=0 imm=1853189958
#line 116 "sample/cgroup_sock_addr2.c"
    r1 = (uint64_t)3924359741021974342;
    // EBPF_OP_STXDW pc=51 dst=r10 src=r1 offset=-40 imm=0
#line 116 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-40)) = (uint64_t)r1;
    // EBPF_OP_MOV64_REG pc=52 dst=r1 src=r10 offset=0 imm=0
#line 116 "sample/cgroup_sock_addr2.c"
    r1 = r10;
    // EBPF_OP_ADD64_IMM pc=53 dst=r1 src=r0 offset=0 imm=-40
#line 116 "sample/cgroup_sock_addr2.c"
    r1 += IMMEDIATE(-40);
    // EBPF_OP_MOV_IMM pc=54 dst=r2 src=r0 offset=0 imm=27
#line 116 "sample/cgroup_sock_addr2.c"
    r2 = IMMEDIATE(27);
#line 116 "sample/cgroup_sock_addr2.c"
    r2 &= UINT32_MAX;
    // EBPF_OP_CALL pc=55 dst=r0 src=r0 offset=0 imm=12
#line 116 "sample/cgroup_sock_addr2.c"
    r0 = runtime_context->helper_data[1].address(r1, r2, r3, r4, r5, context);
#line 116 "sample/cgroup_sock_addr2.c"
    if ((runtime_context->helper_data[1].tail_call) && (r0 == 0)) {
...
#line 116 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_LDXW pc=56 dst=r1 src=r8 offset=20 imm=0
#line 122 "sample/cgroup_sock_addr2.c"
    r1 = *(uint32_t*)(uintptr_t)(r8 + OFFSET(20));
    //  pc=57 dst=r1 src=r0 offset=6 imm=3
#line 122 "sample/cgroup_sock_addr2.c"
    if ((uint32_t)r1 == IMMEDIATE(3)) {
#line 122 "sample/cgroup_sock_addr2.c"
        goto label_2;
...
#line 122 "sample/cgroup_sock_addr2.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=59 dst=r2 src=r0 offset=0 imm=-96
#line 122 "sample/cgroup_sock_addr2.c"
    r2 += IMMEDIATE(-96);
    // EBPF_OP_MOV64_REG pc=60 dst=r1 src=r6 offset=0 imm=0
#line 123 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_MOV_IMM pc=61 dst=r3 src=r0 offset=0 imm=27
#line 123 "sample/cgroup_sock_addr2.c"
    r3 = IMMEDIATE(27);
#line 123 "sample/cgroup_sock_addr2.c"
    r3 &= UINT32_MAX;
    // EBPF_OP_CALL pc=62 dst=r0 src=r0 offset=0 imm=65537
#line 123 "sample/cgroup_sock_addr2.c"
    r0 = runtime_context->helper_data[2].address(r1, r2, r3, r4, r5, context);
#line 123 "sample/cgroup_sock_addr2.c"
    if ((runtime_context->helper_data[2].tail_call) && (r0 == 0)) {
...
#line 123 "sample/cgroup_sock_addr2.c"
    ...
    //  pc=63 dst=r0 src=r0 offset=38 imm=0
#line 123 "sample/cgroup_sock_addr2.c"
    if ((int32_t)r0 < IMMEDIATE(0)) {
#line 123 "sample/cgroup_sock_addr2.c"
        goto label_4;
...
label_2:
    // EBPF_OP_MOV64_REG pc=64 dst=r1 src=r6 offset=0 imm=0
#line 123 "sample/cgroup_sock_addr2.c"
    r1 = r6;
    // EBPF_OP_ADD64_IMM pc=65 dst=r1 src=r0 offset=0 imm=24
#line 123 "sample/cgroup_sock_addr2.c"
    r1 += IMMEDIATE(24);
    // EBPF_OP_LDXW pc=66 dst=r2 src=r8 offset=12 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r8 + OFFSET(12));
    // EBPF_OP_STXW pc=67 dst=r1 src=r2 offset=12 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(12)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=68 dst=r2 src=r8 offset=8 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r8 + OFFSET(8));
    // EBPF_OP_STXW pc=69 dst=r1 src=r2 offset=8 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(8)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=70 dst=r2 src=r8 offset=4 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r8 + OFFSET(4));
    // EBPF_OP_STXW pc=71 dst=r1 src=r2 offset=4 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    *(uint32_t*)(uintptr_t)(r1 + OFFSET(4)) = (uint32_t)r2;
    // EBPF_OP_LDXW pc=72 dst=r2 src=r8 offset=0 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
    r2 = *(uint32_t*)(uintptr_t)(r8 + OFFSET(0));
    // EBPF_OP_STXW pc=73 dst=r1 src=r2 offset=0 imm=0
#line 127 "sample/cgroup_sock_addr2.c"
...
#line 128 "sample/cgroup_sock_addr2.c"
    *(uint16_t*)(uintptr_t)(r6 + OFFSET(40)) = (uint16_t)r1;
    // EBPF_OP_MOV_IMM pc=76 dst=r7 src=r0 offset=0 imm=1
#line 128 "sample/cgroup_sock_addr2.c"
    r7 = IMMEDIATE(1);
#line 128 "sample/cgroup_sock_addr2.c"
    r7 &= UINT32_MAX;
label_3:
    // EBPF_OP_MOV64_IMM pc=77 dst=r1 src=r0 offset=0 imm=0
#line 128 "sample/cgroup_sock_addr2.c"
    r1 = IMMEDIATE(0);
    // EBPF_OP_STXDW pc=78 dst=r10 src=r1 offset=-24 imm=0
#line 43 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-24)) = (uint64_t)r1;
    // EBPF_OP_CALL pc=79 dst=r0 src=r0 offset=0 imm=19
#line 44 "sample/cgroup_sock_addr2.c"
    r0 = runtime_context->helper_data[3].address(r1, r2, r3, r4, r5, context);
#line 44 "sample/cgroup_sock_addr2.c"
    if ((runtime_context->helper_data[3].tail_call) && (r0 == 0)) {
...
#line 44 "sample/cgroup_sock_addr2.c"
    r8 = r0;
    // EBPF_OP_STXDW pc=81 dst=r10 src=r8 offset=-32 imm=0
#line 44 "sample/cgroup_sock_addr2.c"
...
#line 45 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXDW pc=84 dst=r10 src=r0 offset=-40 imm=0
#line 45 "sample/cgroup_sock_addr2.c"
...
#line 48 "sample/cgroup_sock_addr2.c"
    ...
    // EBPF_OP_STXDW pc=92 dst=r10 src=r0 offset=-16 imm=0
#line 48 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-16)) = (uint64_t)r0;
    // EBPF_OP_STXDW pc=93 dst=r10 src=r8 offset=-8 imm=0
#line 50 "sample/cgroup_sock_addr2.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-8)) = (uint64_t)r8;
...
#line 50 "sample/cgroup_sock_addr2.c"
    r3 = r10;
    // EBPF_OP_ADD64_IMM pc=97 dst=r3 src=r0 offset=0 imm=-40
#line 50 "sample/cgroup_sock_addr2.c"
    r3 += IMMEDIATE(-40);
    // EBPF_OP_LDDW pc=98 dst=r1 src=r1 offset=0 imm=2
#line 51 "sample/cgroup_sock_addr2.c"
    r1 = POINTER(runtime_context->map_data[1].address);
...
label_4:
    // EBPF_OP_MOV_REG pc=102 dst=r0 src=r7 offset=0 imm=0
