...
static program_entry_t _programs[] = {
    {
        ...
        .function = function_v4,
        .pe_section_name = "cgroup~2",
        .section_name = "cgroup/connect4",
        .program_name = "function_v4",
        .referenced_map_indices = function_v4_maps,
        .referenced_map_count = 1,
        .helpers = function_v4_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 19,
        .program_type = &function_v4_program_type_guid,
        .expected_attach_type = &function_v4_attach_type_guid,
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = function_v6,
        .pe_section_name = "cgroup~1",
        .section_name = "cgroup/connect6",
        .program_name = "function_v6",
        .referenced_map_indices = function_v6_maps,
        .referenced_map_count = 1,
        .helpers = function_v6_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 19,
        .program_type = &function_v6_program_type_guid,
        .expected_attach_type = &function_v6_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
