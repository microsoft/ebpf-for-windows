...
static program_entry_t _programs[] = {
    {
        ...
        .program_type = &program1_program_type_guid,
        .expected_attach_type = &program1_attach_type_guid,
    ...
    },
    {
        ...
        .helper_count = 0,
        .bpf_instruction_count = 2,
        .program_type = &program2_program_type_guid,
        .expected_attach_type = &program2_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        ...
        .helper_count = 0,
        .bpf_instruction_count = 2,
        .program_type = &program3_program_type_guid,
        .expected_attach_type = &program3_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        ...
        .helper_count = 0,
        .bpf_instruction_count = 2,
        .program_type = &program4_program_type_guid,
        .expected_attach_type = &program4_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
