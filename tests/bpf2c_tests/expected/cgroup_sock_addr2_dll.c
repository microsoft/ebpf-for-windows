...
static program_entry_t _programs[] = {
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = connect_redirect4,
        .pe_section_name = "cgroup~4",
        .section_name = "cgroup/connect4",
        .program_name = "connect_redirect4",
        .referenced_map_indices = connect_redirect4_maps,
        .referenced_map_count = 2,
        .helpers = connect_redirect4_helpers,
        .helper_count = 8,
        .bpf_instruction_count = 101,
        .program_type = &connect_redirect4_program_type_guid,
        .expected_attach_type = &connect_redirect4_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = connect_redirect6,
        .pe_section_name = "cgroup~3",
        .section_name = "cgroup/connect6",
        .program_name = "connect_redirect6",
        .referenced_map_indices = connect_redirect6_maps,
        .referenced_map_count = 2,
        .helpers = connect_redirect6_helpers,
        .helper_count = 8,
        .bpf_instruction_count = 109,
        .program_type = &connect_redirect6_program_type_guid,
        .expected_attach_type = &connect_redirect6_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
