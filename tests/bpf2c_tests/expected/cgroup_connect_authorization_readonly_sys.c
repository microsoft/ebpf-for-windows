...
static program_entry_t _programs[] = {
    {
        ...
        .function = mutate_connect_authorization4,
        .pe_section_name = "cgroup~2",
        .section_name = "cgroup/connect_authorization4",
        .program_name = "mutate_connect_authorization4",
        .referenced_map_indices = NULL,
        .referenced_map_count = 0,
        .helpers = NULL,
        .helper_count = 0,
        .bpf_instruction_count = 10,
        .program_type = &mutate_connect_authorization4_program_type_guid,
        .expected_attach_type = &mutate_connect_authorization4_attach_type_guid,
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = mutate_connect_authorization6,
        .pe_section_name = "cgroup~1",
        .section_name = "cgroup/connect_authorization6",
        .program_name = "mutate_connect_authorization6",
        .referenced_map_indices = NULL,
        .referenced_map_count = 0,
        .helpers = NULL,
        .helper_count = 0,
        .bpf_instruction_count = 10,
        .program_type = &mutate_connect_authorization6_program_type_guid,
        .expected_attach_type = &mutate_connect_authorization6_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
