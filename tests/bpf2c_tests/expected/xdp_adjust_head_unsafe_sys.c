...
#line 18 "sample/unsafe/xdp_adjust_head_unsafe.c"
{
#line 18 "sample/unsafe/xdp_adjust_head_unsafe.c"
    // Prologue
#line 18 "sample/unsafe/xdp_adjust_head_unsafe.c"
...
#line 27 "sample/unsafe/xdp_adjust_head_unsafe.c"
    r2 = *(uint64_t*)(uintptr_t)(r7 + OFFSET(8));
    // EBPF_OP_LDXDW pc=3 dst=r1 src=r7 offset=0 imm=0
#line 23 "sample/unsafe/xdp_adjust_head_unsafe.c"
...
#line 43 "sample/unsafe/xdp_adjust_head_unsafe.c"
    *(uint16_t*)(uintptr_t)(r1 + OFFSET(12)) = (uint16_t)r8;
...
#line 46 "sample/unsafe/xdp_adjust_head_unsafe.c"
    r0 = r6;
