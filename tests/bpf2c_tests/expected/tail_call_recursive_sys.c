...
#line 33 "sample/tail_call_recursive.c"
    r1 = *(uint32_t*)(uintptr_t)(r0 + OFFSET(0));
    // EBPF_OP_ADD64_IMM pc=10 dst=r1 src=r0 offset=0 imm=1
#line 33 "sample/tail_call_recursive.c"
    r1 += IMMEDIATE(1);
    // EBPF_OP_STXW pc=11 dst=r0 src=r1 offset=0 imm=0
#line 33 "sample/tail_call_recursive.c"
    *(uint32_t*)(uintptr_t)(r0 + OFFSET(0)) = (uint32_t)r1;
    // EBPF_OP_MOV64_REG pc=12 dst=r1 src=r6 offset=0 imm=0
#line 36 "sample/tail_call_recursive.c"
    r1 = r6;
    // EBPF_OP_LDDW pc=13 dst=r2 src=r0 offset=0 imm=0
#line 36 "sample/tail_call_recursive.c"
    r2 = POINTER(_maps[0].address);
    // EBPF_OP_MOV64_IMM pc=15 dst=r3 src=r0 offset=0 imm=0
#line 36 "sample/tail_call_recursive.c"
    r3 = IMMEDIATE(0);
    // EBPF_OP_CALL pc=16 dst=r0 src=r0 offset=0 imm=5
#line 36 "sample/tail_call_recursive.c"
...
#line 36 "sample/tail_call_recursive.c"
    r7 = r0;
label_1:
    // EBPF_OP_MOV64_REG pc=18 dst=r0 src=r7 offset=0 imm=0
#line 37 "sample/tail_call_recursive.c"
    r0 = r7;
