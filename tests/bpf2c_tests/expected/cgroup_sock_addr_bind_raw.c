...
static program_entry_t _programs[] = {
    {
        ...
        .function = authorize_bind4,
        .pe_section_name = "cgroup~2",
        .section_name = "cgroup/bind4",
        .program_name = "authorize_bind4",
        .referenced_map_indices = authorize_bind4_maps,
        .referenced_map_count = 1,
        .helpers = authorize_bind4_helpers,
        .helper_count = 1,
        .bpf_instruction_count = 16,
        .program_type = &authorize_bind4_program_type_guid,
        .expected_attach_type = &authorize_bind4_attach_type_guid,
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = authorize_bind6,
        .pe_section_name = "cgroup~1",
        .section_name = "cgroup/bind6",
        .program_name = "authorize_bind6",
        .referenced_map_indices = authorize_bind6_maps,
        .referenced_map_count = 1,
        .helpers = authorize_bind6_helpers,
        .helper_count = 1,
        .bpf_instruction_count = 16,
        .program_type = &authorize_bind6_program_type_guid,
        .expected_attach_type = &authorize_bind6_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
