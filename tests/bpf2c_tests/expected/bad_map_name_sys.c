...
static map_entry_t _maps[] = {
    {NULL,
     ...
     "this_map_has_a_name_that_is_longer_than_what_the_ebofcore_driver_can_support"},
};
#pragma data_seg(pop)
...
metadata_table_t bad_map_name_metadata_table = {_get_programs, _get_maps, _get_hash};
