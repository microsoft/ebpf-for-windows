...
// This file was generated from bindmonitor_bpf2bpf_maps.o
...
#define metadata_table bindmonitor_bpf2bpf_maps##_metadata_table
...
static helper_function_entry_t BindMonitor_MapCallee_helpers[] = {
    {
...
static uint64_t
BindMonitor_UpdateMap(uint64_t r1, uint64_t r2, uint64_t r3, uint64_t r4, uint64_t r5, uint64_t r10, void* context, const program_runtime_context_t* runtime_context);

static GUID BindMonitor_MapCallee_program_type_guid = {
    0x608c517c, 0x6c52, 0x4a26, {0xb6, 0x77, 0xbb, 0x1c, 0x34, 0x42, 0x5a, 0xdf}};
static GUID BindMonitor_MapCallee_attach_type_guid = {
    0xb9707e04, 0x8127, 0x4c72, {0x83, 0x3e, 0x05, 0xb1, 0xfb, 0x43, 0x94, 0x96}};
static uint16_t BindMonitor_MapCallee_maps[] = {
    0,
};

#pragma code_seg(push, "bind")
static uint64_t
BindMonitor_MapCallee(void* context, const program_runtime_context_t* runtime_context)
#line 65 "sample/bindmonitor_bpf2bpf_maps.c"
{
#line 65 "sample/bindmonitor_bpf2bpf_maps.c"
    // Prologue.
#line 65 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 68 "sample/bindmonitor_bpf2bpf_maps.c"
    r0 = BindMonitor_UpdateMap(r1, r2, r3, r4, r5, r10, context, runtime_context);
...
#line 70 "sample/bindmonitor_bpf2bpf_maps.c"
    if (r1 != IMMEDIATE(0)) {
#line 70 "sample/bindmonitor_bpf2bpf_maps.c"
        goto label_1;
#line 70 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 75 "sample/bindmonitor_bpf2bpf_maps.c"
    return r0;
#line 65 "sample/bindmonitor_bpf2bpf_maps.c"
}
#pragma code_seg(pop)
...
#line 43 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 46 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 47 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 51 "sample/bindmonitor_bpf2bpf_maps.c"
    r2 += IMMEDIATE(-24);
...
#line 52 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 53 "sample/bindmonitor_bpf2bpf_maps.c"
    READ_ONCE_64(r1, r10, OFFSET(-48));
...
#line 54 "sample/bindmonitor_bpf2bpf_maps.c"
    r1 = POINTER(runtime_context->map_data[0].address);
...
#line 56 "sample/bindmonitor_bpf2bpf_maps.c"
...
#line 57 "sample/bindmonitor_bpf2bpf_maps.c"
    r1 = POINTER(runtime_context->map_data[0].address);
...
#line 59 "sample/bindmonitor_bpf2bpf_maps.c"
...
static program_entry_t _programs[] = {
    {
        ...
        BindMonitor_MapCallee,
        "bind",
        "bind",
        "BindMonitor_MapCallee",
        BindMonitor_MapCallee_maps,
        1,
        BindMonitor_MapCallee_helpers,
        3,
        12,
        &BindMonitor_MapCallee_program_type_guid,
        &BindMonitor_MapCallee_attach_type_guid,
    },
};
#pragma data_seg(pop)
...
metadata_table_t bindmonitor_bpf2bpf_maps_metadata_table = {
