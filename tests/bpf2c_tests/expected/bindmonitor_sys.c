...
#line 119 "sample/bindmonitor.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JEQ_IMM pc=26 dst=r0 src=r0 offset=75 imm=0
...
#line 120 "sample/bindmonitor.c"
    ...
    // EBPF_OP_LDXW pc=27 dst=r2 src=r0 offset=0 imm=0
#line 120 "sample/bindmonitor.c"
    READ_ONCE_32(r2, r0, OFFSET(0));
    // EBPF_OP_JEQ_IMM pc=28 dst=r2 src=r0 offset=73 imm=0
#line 120 "sample/bindmonitor.c"
    if (r2 == IMMEDIATE(0)) {
#line 120 "sample/bindmonitor.c"
        goto label_6;
...
#line 78 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JNE_IMM pc=47 dst=r0 src=r0 offset=29 imm=0
...
#line 83 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JNE_IMM pc=49 dst=r1 src=r0 offset=51 imm=0
#line 83 "sample/bindmonitor.c"
    if (r1 != IMMEDIATE(0)) {
#line 83 "sample/bindmonitor.c"
        goto label_5;
...
#line 87 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JEQ_IMM pc=51 dst=r1 src=r0 offset=49 imm=0
#line 87 "sample/bindmonitor.c"
    if (r1 == IMMEDIATE(0)) {
#line 87 "sample/bindmonitor.c"
        goto label_5;
...
#line 87 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JEQ_IMM pc=53 dst=r1 src=r0 offset=47 imm=0
#line 87 "sample/bindmonitor.c"
    if (r1 == IMMEDIATE(0)) {
#line 87 "sample/bindmonitor.c"
        goto label_5;
#line 87 "sample/bindmonitor.c"
    ...
    // EBPF_OP_MOV64_REG pc=54 dst=r7 src=r10 offset=0 imm=0
#line 87 "sample/bindmonitor.c"
    r7 = r10;
    // EBPF_OP_ADD64_IMM pc=55 dst=r7 src=r0 offset=0 imm=-8
...
#line 91 "sample/bindmonitor.c"
    r1 = POINTER(runtime_context->map_data[1].address);
    // EBPF_OP_MOV64_REG pc=60 dst=r2 src=r7 offset=0 imm=0
#line 91 "sample/bindmonitor.c"
    r2 = r7;
...
#line 92 "sample/bindmonitor.c"
    r1 = POINTER(runtime_context->map_data[1].address);
    // EBPF_OP_MOV64_REG pc=65 dst=r2 src=r7 offset=0 imm=0
#line 92 "sample/bindmonitor.c"
    r2 = r7;
...
#line 92 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JEQ_IMM pc=67 dst=r0 src=r0 offset=33 imm=0
...
#line 93 "sample/bindmonitor.c"
    ...
    // EBPF_OP_LDXDW pc=68 dst=r3 src=r6 offset=0 imm=0
#line 97 "sample/bindmonitor.c"
    READ_ONCE_64(r3, r6, OFFSET(0));
    // EBPF_OP_LDXDW pc=69 dst=r4 src=r6 offset=8 imm=0
#line 97 "sample/bindmonitor.c"
    READ_ONCE_64(r4, r6, OFFSET(8));
    // EBPF_OP_SUB64_REG pc=70 dst=r4 src=r3 offset=0 imm=0
#line 97 "sample/bindmonitor.c"
    r4 -= r3;
    // EBPF_OP_MOV64_REG pc=71 dst=r1 src=r0 offset=0 imm=0
#line 97 "sample/bindmonitor.c"
    r1 = r0;
    // EBPF_OP_ADD64_IMM pc=72 dst=r1 src=r0 offset=0 imm=4
#line 97 "sample/bindmonitor.c"
    r1 += IMMEDIATE(4);
    // EBPF_OP_MOV64_IMM pc=73 dst=r2 src=r0 offset=0 imm=64
#line 97 "sample/bindmonitor.c"
    r2 = IMMEDIATE(64);
    // EBPF_OP_MOV64_REG pc=74 dst=r7 src=r0 offset=0 imm=0
#line 97 "sample/bindmonitor.c"
    r7 = r0;
...
#line 97 "sample/bindmonitor.c"
    r0 = r7;
label_1:
    // EBPF_OP_LDXW pc=77 dst=r2 src=r0 offset=0 imm=0
#line 97 "sample/bindmonitor.c"
    READ_ONCE_32(r2, r0, OFFSET(0));
    // EBPF_OP_LDXW pc=78 dst=r1 src=r6 offset=44 imm=0
#line 130 "sample/bindmonitor.c"
    READ_ONCE_32(r1, r6, OFFSET(44));
    // EBPF_OP_JEQ_IMM pc=79 dst=r1 src=r0 offset=7 imm=2
#line 130 "sample/bindmonitor.c"
    if (r1 == IMMEDIATE(2)) {
#line 130 "sample/bindmonitor.c"
        goto label_2;
#line 130 "sample/bindmonitor.c"
    ...
    // EBPF_OP_JNE_IMM pc=80 dst=r1 src=r0 offset=9 imm=0
#line 130 "sample/bindmonitor.c"
    if (r1 != IMMEDIATE(0)) {
#line 130 "sample/bindmonitor.c"
        goto label_3;
#line 130 "sample/bindmonitor.c"
    ...
    // EBPF_OP_MOV64_IMM pc=81 dst=r1 src=r0 offset=0 imm=0
#line 130 "sample/bindmonitor.c"
    r1 = IMMEDIATE(0);
    // EBPF_OP_LDXW pc=82 dst=r3 src=r8 offset=0 imm=0
#line 132 "sample/bindmonitor.c"
    READ_ONCE_32(r3, r8, OFFSET(0));
    // EBPF_OP_JGE_REG pc=83 dst=r2 src=r3 offset=18 imm=0
#line 132 "sample/bindmonitor.c"
    if (r2 >= r3) {
#line 132 "sample/bindmonitor.c"
        goto label_6;
#line 132 "sample/bindmonitor.c"
    ...
    // EBPF_OP_ADD64_IMM pc=84 dst=r2 src=r0 offset=0 imm=1
#line 136 "sample/bindmonitor.c"
    r2 += IMMEDIATE(1);
    // EBPF_OP_STXW pc=85 dst=r0 src=r2 offset=0 imm=0
#line 136 "sample/bindmonitor.c"
    WRITE_ONCE_32(r0, (uint32_t)r2, OFFSET(0));
    // EBPF_OP_JA pc=86 dst=r0 src=r0 offset=14 imm=0
#line 136 "sample/bindmonitor.c"
    goto label_5;
label_2:
    // EBPF_OP_JEQ_IMM pc=87 dst=r2 src=r0 offset=6 imm=0
...
#line 139 "sample/bindmonitor.c"
    ...
    // EBPF_OP_ADD64_IMM pc=88 dst=r2 src=r0 offset=0 imm=-1
#line 140 "sample/bindmonitor.c"
    r2 += IMMEDIATE(-1);
    // EBPF_OP_STXW pc=89 dst=r0 src=r2 offset=0 imm=0
#line 140 "sample/bindmonitor.c"
    WRITE_ONCE_32(r0, (uint32_t)r2, OFFSET(0));
label_3:
    // EBPF_OP_LSH64_IMM pc=90 dst=r2 src=r0 offset=0 imm=32
#line 147 "sample/bindmonitor.c"
    r2 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_RSH64_IMM pc=91 dst=r2 src=r0 offset=0 imm=32
#line 147 "sample/bindmonitor.c"
    r2 >>= (IMMEDIATE(32) & 63);
    // EBPF_OP_MOV64_IMM pc=92 dst=r1 src=r0 offset=0 imm=1
#line 147 "sample/bindmonitor.c"
    r1 = IMMEDIATE(1);
    // EBPF_OP_JNE_IMM pc=93 dst=r2 src=r0 offset=8 imm=0
#line 147 "sample/bindmonitor.c"
    if (r2 != IMMEDIATE(0)) {
#line 147 "sample/bindmonitor.c"
        goto label_6;
...
label_4:
    // EBPF_OP_LDXDW pc=94 dst=r1 src=r6 offset=16 imm=0
#line 148 "sample/bindmonitor.c"
    READ_ONCE_64(r1, r6, OFFSET(16));
    // EBPF_OP_STXDW pc=95 dst=r10 src=r1 offset=-80 imm=0
#line 148 "sample/bindmonitor.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-80));
    // EBPF_OP_MOV64_REG pc=96 dst=r2 src=r10 offset=0 imm=0
#line 148 "sample/bindmonitor.c"
    r2 = r10;
    // EBPF_OP_ADD64_IMM pc=97 dst=r2 src=r0 offset=0 imm=-80
#line 148 "sample/bindmonitor.c"
    r2 += IMMEDIATE(-80);
    // EBPF_OP_LDDW pc=98 dst=r1 src=r1 offset=0 imm=2
#line 149 "sample/bindmonitor.c"
    r1 = POINTER(runtime_context->map_data[1].address);
    // EBPF_OP_CALL pc=100 dst=r0 src=r0 offset=0 imm=3
#line 149 "sample/bindmonitor.c"
...
label_5:
    // EBPF_OP_MOV64_IMM pc=101 dst=r1 src=r0 offset=0 imm=1
#line 149 "sample/bindmonitor.c"
    r1 = IMMEDIATE(1);
label_6:
    // EBPF_OP_MOV64_REG pc=102 dst=r0 src=r1 offset=0 imm=0
