...
#line 60 "sample/sockops.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-56)) = (uint64_t)r3;
    // EBPF_OP_LDXB pc=59 dst=r4 src=r1 offset=21 imm=0
#line 60 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(21));
    // EBPF_OP_LSH64_IMM pc=60 dst=r4 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r4 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=61 dst=r3 src=r1 offset=20 imm=0
#line 60 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(20));
    // EBPF_OP_OR64_REG pc=62 dst=r4 src=r3 offset=0 imm=0
#line 60 "sample/sockops.c"
    r4 |= r3;
    // EBPF_OP_LDXB pc=63 dst=r3 src=r1 offset=23 imm=0
#line 60 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(23));
    // EBPF_OP_LSH64_IMM pc=64 dst=r3 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=65 dst=r5 src=r1 offset=22 imm=0
#line 60 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(22));
    // EBPF_OP_OR64_REG pc=66 dst=r3 src=r5 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r5;
    // EBPF_OP_LDXB pc=67 dst=r0 src=r1 offset=17 imm=0
#line 60 "sample/sockops.c"
    r0 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(17));
    // EBPF_OP_LSH64_IMM pc=68 dst=r0 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r0 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=69 dst=r5 src=r1 offset=16 imm=0
#line 60 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(16));
    // EBPF_OP_OR64_REG pc=70 dst=r0 src=r5 offset=0 imm=0
#line 60 "sample/sockops.c"
    r0 |= r5;
    // EBPF_OP_LDXB pc=71 dst=r5 src=r1 offset=19 imm=0
#line 60 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(19));
    // EBPF_OP_LSH64_IMM pc=72 dst=r5 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r5 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=73 dst=r7 src=r1 offset=18 imm=0
#line 60 "sample/sockops.c"
    r7 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(18));
    // EBPF_OP_OR64_REG pc=74 dst=r5 src=r7 offset=0 imm=0
#line 60 "sample/sockops.c"
    r5 |= r7;
    // EBPF_OP_LSH64_IMM pc=75 dst=r5 src=r0 offset=0 imm=16
#line 60 "sample/sockops.c"
    r5 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=76 dst=r5 src=r0 offset=0 imm=0
#line 60 "sample/sockops.c"
    r5 |= r0;
    // EBPF_OP_LSH64_IMM pc=77 dst=r3 src=r0 offset=0 imm=16
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=78 dst=r3 src=r4 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r4;
    // EBPF_OP_LDXB pc=79 dst=r0 src=r1 offset=9 imm=0
#line 60 "sample/sockops.c"
    r0 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(9));
    // EBPF_OP_LSH64_IMM pc=80 dst=r0 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r0 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=81 dst=r4 src=r1 offset=8 imm=0
#line 60 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(8));
    // EBPF_OP_OR64_REG pc=82 dst=r0 src=r4 offset=0 imm=0
#line 60 "sample/sockops.c"
    r0 |= r4;
    // EBPF_OP_LDXB pc=83 dst=r4 src=r1 offset=11 imm=0
#line 60 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(11));
    // EBPF_OP_LSH64_IMM pc=84 dst=r4 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r4 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=85 dst=r7 src=r1 offset=10 imm=0
#line 60 "sample/sockops.c"
    r7 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(10));
    // EBPF_OP_OR64_REG pc=86 dst=r4 src=r7 offset=0 imm=0
#line 60 "sample/sockops.c"
    r4 |= r7;
    // EBPF_OP_OR64_REG pc=87 dst=r6 src=r2 offset=0 imm=0
#line 70 "sample/sockops.c"
    r6 |= r2;
    // EBPF_OP_LSH64_IMM pc=88 dst=r3 src=r0 offset=0 imm=32
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_OR64_REG pc=89 dst=r3 src=r5 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r5;
    // EBPF_OP_STXDW pc=90 dst=r10 src=r3 offset=-64 imm=0
#line 60 "sample/sockops.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-64)) = (uint64_t)r3;
    // EBPF_OP_LSH64_IMM pc=91 dst=r4 src=r0 offset=0 imm=16
#line 60 "sample/sockops.c"
    r4 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=92 dst=r4 src=r0 offset=0 imm=0
#line 60 "sample/sockops.c"
    r4 |= r0;
...
#line 60 "sample/sockops.c"
    r2 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=95 dst=r3 src=r1 offset=12 imm=0
#line 60 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(12));
    // EBPF_OP_OR64_REG pc=96 dst=r2 src=r3 offset=0 imm=0
#line 60 "sample/sockops.c"
    r2 |= r3;
    // EBPF_OP_LDXB pc=97 dst=r3 src=r1 offset=15 imm=0
#line 60 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(15));
    // EBPF_OP_LSH64_IMM pc=98 dst=r3 src=r0 offset=0 imm=8
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=99 dst=r5 src=r1 offset=14 imm=0
#line 60 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(14));
    // EBPF_OP_OR64_REG pc=100 dst=r3 src=r5 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r5;
    // EBPF_OP_LSH64_IMM pc=101 dst=r3 src=r0 offset=0 imm=16
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=102 dst=r3 src=r2 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r2;
    // EBPF_OP_LSH64_IMM pc=103 dst=r3 src=r0 offset=0 imm=32
#line 60 "sample/sockops.c"
    r3 <<= (IMMEDIATE(32) & 63);
    // EBPF_OP_OR64_REG pc=104 dst=r3 src=r4 offset=0 imm=0
#line 60 "sample/sockops.c"
    r3 |= r4;
    // EBPF_OP_STXDW pc=105 dst=r10 src=r3 offset=-72 imm=0
#line 60 "sample/sockops.c"
    *(uint64_t*)(uintptr_t)(r10 + OFFSET(-72)) = (uint64_t)r3;
...
#line 61 "sample/sockops.c"
    *(uint16_t*)(uintptr_t)(r10 + OFFSET(-56)) = (uint16_t)r2;
    // EBPF_OP_LDXB pc=108 dst=r4 src=r1 offset=41 imm=0
#line 63 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(41));
    // EBPF_OP_LSH64_IMM pc=109 dst=r4 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r4 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=110 dst=r2 src=r1 offset=40 imm=0
#line 63 "sample/sockops.c"
    r2 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(40));
    // EBPF_OP_OR64_REG pc=111 dst=r4 src=r2 offset=0 imm=0
#line 63 "sample/sockops.c"
    r4 |= r2;
    // EBPF_OP_LDXB pc=112 dst=r2 src=r1 offset=43 imm=0
#line 63 "sample/sockops.c"
    r2 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(43));
    // EBPF_OP_LSH64_IMM pc=113 dst=r2 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r2 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=114 dst=r3 src=r1 offset=42 imm=0
#line 63 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(42));
    // EBPF_OP_OR64_REG pc=115 dst=r2 src=r3 offset=0 imm=0
#line 63 "sample/sockops.c"
    r2 |= r3;
    // EBPF_OP_LDXB pc=116 dst=r5 src=r1 offset=29 imm=0
#line 63 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(29));
    // EBPF_OP_LSH64_IMM pc=117 dst=r5 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r5 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=118 dst=r3 src=r1 offset=28 imm=0
#line 63 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(28));
    // EBPF_OP_OR64_REG pc=119 dst=r5 src=r3 offset=0 imm=0
#line 63 "sample/sockops.c"
    r5 |= r3;
    // EBPF_OP_LDXB pc=120 dst=r3 src=r1 offset=31 imm=0
#line 63 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(31));
    // EBPF_OP_LSH64_IMM pc=121 dst=r3 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r3 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=122 dst=r0 src=r1 offset=30 imm=0
#line 63 "sample/sockops.c"
    r0 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(30));
    // EBPF_OP_OR64_REG pc=123 dst=r3 src=r0 offset=0 imm=0
#line 63 "sample/sockops.c"
    r3 |= r0;
    // EBPF_OP_LSH64_IMM pc=124 dst=r3 src=r0 offset=0 imm=16
#line 63 "sample/sockops.c"
    r3 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=125 dst=r3 src=r5 offset=0 imm=0
#line 63 "sample/sockops.c"
    r3 |= r5;
    // EBPF_OP_LSH64_IMM pc=126 dst=r2 src=r0 offset=0 imm=16
#line 63 "sample/sockops.c"
    r2 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=127 dst=r2 src=r4 offset=0 imm=0
#line 63 "sample/sockops.c"
    r2 |= r4;
    // EBPF_OP_LDXB pc=128 dst=r4 src=r1 offset=37 imm=0
#line 63 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(37));
    // EBPF_OP_LSH64_IMM pc=129 dst=r4 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r4 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=130 dst=r5 src=r1 offset=36 imm=0
#line 63 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(36));
    // EBPF_OP_OR64_REG pc=131 dst=r4 src=r5 offset=0 imm=0
#line 63 "sample/sockops.c"
    r4 |= r5;
    // EBPF_OP_LDXB pc=132 dst=r5 src=r1 offset=39 imm=0
#line 63 "sample/sockops.c"
    r5 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(39));
    // EBPF_OP_LSH64_IMM pc=133 dst=r5 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r5 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=134 dst=r0 src=r1 offset=38 imm=0
#line 63 "sample/sockops.c"
    r0 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(38));
    // EBPF_OP_OR64_REG pc=135 dst=r5 src=r0 offset=0 imm=0
#line 63 "sample/sockops.c"
    r5 |= r0;
    // EBPF_OP_LSH64_IMM pc=136 dst=r5 src=r0 offset=0 imm=16
#line 63 "sample/sockops.c"
    r5 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=137 dst=r5 src=r4 offset=0 imm=0
#line 63 "sample/sockops.c"
    r5 |= r4;
    // EBPF_OP_STXW pc=138 dst=r10 src=r5 offset=-44 imm=0
#line 63 "sample/sockops.c"
...
#line 63 "sample/sockops.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-40)) = (uint32_t)r2;
    // EBPF_OP_STXW pc=140 dst=r10 src=r3 offset=-52 imm=0
#line 63 "sample/sockops.c"
    *(uint32_t*)(uintptr_t)(r10 + OFFSET(-52)) = (uint32_t)r3;
...
#line 63 "sample/sockops.c"
    r2 |= r3;
    // EBPF_OP_LDXB pc=145 dst=r3 src=r1 offset=35 imm=0
#line 63 "sample/sockops.c"
    r3 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(35));
    // EBPF_OP_LSH64_IMM pc=146 dst=r3 src=r0 offset=0 imm=8
#line 63 "sample/sockops.c"
    r3 <<= (IMMEDIATE(8) & 63);
    // EBPF_OP_LDXB pc=147 dst=r4 src=r1 offset=34 imm=0
#line 63 "sample/sockops.c"
    r4 = *(uint8_t*)(uintptr_t)(r1 + OFFSET(34));
    // EBPF_OP_OR64_REG pc=148 dst=r3 src=r4 offset=0 imm=0
#line 63 "sample/sockops.c"
    r3 |= r4;
    // EBPF_OP_LSH64_IMM pc=149 dst=r3 src=r0 offset=0 imm=16
#line 63 "sample/sockops.c"
    r3 <<= (IMMEDIATE(16) & 63);
    // EBPF_OP_OR64_REG pc=150 dst=r3 src=r2 offset=0 imm=0
#line 63 "sample/sockops.c"
    r3 |= r2;
    // EBPF_OP_STXW pc=151 dst=r10 src=r3 offset=-48 imm=0
#line 63 "sample/sockops.c"
