...
label_1:
    // EBPF_OP_MOV64_IMM pc=14 dst=r0 src=r0 offset=0 imm=1
#line 345 "sample/bindmonitor_tailcall.c"
    r0 = IMMEDIATE(1);
    // EBPF_OP_EXIT pc=15 dst=r0 src=r0 offset=0 imm=0
#line 345 "sample/bindmonitor_tailcall.c"
    return r0;
...
#line 350 "sample/bindmonitor_tailcall.c"
{
#line 350 "sample/bindmonitor_tailcall.c"
    // Prologue
#line 350 "sample/bindmonitor_tailcall.c"
...
#line 352 "sample/bindmonitor_tailcall.c"
    r2 += IMMEDIATE(-84);
    // EBPF_OP_LDDW pc=5 dst=r1 src=r0 offset=0 imm=0
#line 354 "sample/bindmonitor_tailcall.c"
...
#line 355 "sample/bindmonitor_tailcall.c"
    if (r7 == IMMEDIATE(0))
#line 355 "sample/bindmonitor_tailcall.c"
        goto label_9;
...
#line 361 "sample/bindmonitor_tailcall.c"
    if (r0 == IMMEDIATE(0))
#line 361 "sample/bindmonitor_tailcall.c"
        goto label_9;
label_2:
...
#line 382 "sample/bindmonitor_tailcall.c"
...
#line 304 "sample/bindmonitor_tailcall.c"
    r1 = *(uint64_t*)(uintptr_t)(r6 + OFFSET(0));
...
#line 305 "sample/bindmonitor_tailcall.c"
...
#line 375 "sample/bindmonitor_tailcall.c"
    r1 += IMMEDIATE(-1);
...
#line 383 "sample/bindmonitor_tailcall.c"
    r1 = *(uint64_t*)(uintptr_t)(r6 + OFFSET(16));
...
#line 384 "sample/bindmonitor_tailcall.c"
    r1 = POINTER(_maps[0].address);
...
#line 367 "sample/bindmonitor_tailcall.c"
    r1 = *(uint32_t*)(uintptr_t)(r0 + OFFSET(0));
...
#line 388 "sample/bindmonitor_tailcall.c"
    r0 = r8;
