...
static program_entry_t _programs[] = {
    {
        ...
        .function = test_map_delete_element,
        .pe_section_name = "sample~5",
        .section_name = "sample_ext",
        .program_name = "test_map_delete_element",
        .referenced_map_indices = test_map_delete_element_maps,
        .referenced_map_count = 3,
        .helpers = test_map_delete_element_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 35,
        .program_type = &test_map_delete_element_program_type_guid,
        .expected_attach_type = &test_map_delete_element_attach_type_guid,
    ...
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_find_and_delete_element,
        .pe_section_name = "sample~4",
        .section_name = "sample_ext",
        .program_name = "test_map_find_and_delete_element",
        .referenced_map_indices = test_map_find_and_delete_element_maps,
        .referenced_map_count = 3,
        .helpers = test_map_find_and_delete_element_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 33,
        .program_type = &test_map_find_and_delete_element_program_type_guid,
        .expected_attach_type = &test_map_find_and_delete_element_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_peek_elem,
        .pe_section_name = "sample~1",
        .section_name = "sample_ext",
        .program_name = "test_map_peek_elem",
        .referenced_map_indices = test_map_peek_elem_maps,
        .referenced_map_count = 3,
        .helpers = test_map_peek_elem_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 35,
        .program_type = &test_map_peek_elem_program_type_guid,
        .expected_attach_type = &test_map_peek_elem_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_pop_elem,
        .pe_section_name = "sample~2",
        .section_name = "sample_ext",
        .program_name = "test_map_pop_elem",
        .referenced_map_indices = test_map_pop_elem_maps,
        .referenced_map_count = 3,
        .helpers = test_map_pop_elem_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 35,
        .program_type = &test_map_pop_elem_program_type_guid,
        .expected_attach_type = &test_map_pop_elem_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_push_elem,
        .pe_section_name = "sample~3",
        .section_name = "sample_ext",
        .program_name = "test_map_push_elem",
        .referenced_map_indices = test_map_push_elem_maps,
        .referenced_map_count = 3,
        .helpers = test_map_push_elem_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 37,
        .program_type = &test_map_push_elem_program_type_guid,
        .expected_attach_type = &test_map_push_elem_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_read_helper_increment,
        .pe_section_name = "sample~9",
        .section_name = "sample_ext",
        .program_name = "test_map_read_helper_increment",
        .referenced_map_indices = test_map_read_helper_increment_maps,
        .referenced_map_count = 3,
        .helpers = test_map_read_helper_increment_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 37,
        .program_type = &test_map_read_helper_increment_program_type_guid,
        .expected_attach_type = &test_map_read_helper_increment_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_read_helper_increment_invalid,
        .pe_section_name = "sample~7",
        .section_name = "sample_ext",
        .program_name = "test_map_read_helper_increment_invalid",
        .referenced_map_indices = test_map_read_helper_increment_invalid_maps,
        .referenced_map_count = 2,
        .helpers = test_map_read_helper_increment_invalid_helpers,
        .helper_count = 2,
        .bpf_instruction_count = 26,
        .program_type = &test_map_read_helper_increment_invalid_program_type_guid,
        .expected_attach_type = &test_map_read_helper_increment_invalid_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_read_helper_value,
        .pe_section_name = "sample~8",
        .section_name = "sample_ext",
        .program_name = "test_map_read_helper_value",
        .referenced_map_indices = test_map_read_helper_value_maps,
        .referenced_map_count = 4,
        .helpers = test_map_read_helper_value_helpers,
        .helper_count = 3,
        .bpf_instruction_count = 59,
        .program_type = &test_map_read_helper_value_program_type_guid,
        .expected_attach_type = &test_map_read_helper_value_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_read_increment,
        .pe_section_name = "sampl~10",
        .section_name = "sample_ext",
        .program_name = "test_map_read_increment",
        .referenced_map_indices = test_map_read_increment_maps,
        .referenced_map_count = 3,
        .helpers = test_map_read_increment_helpers,
        .helper_count = 2,
        .bpf_instruction_count = 37,
        .program_type = &test_map_read_increment_program_type_guid,
        .expected_attach_type = &test_map_read_increment_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
    {
        .zero = 0,
        .header = {1, 144, 160}, // Version header.
        .function = test_map_update_element,
        .pe_section_name = "sample~6",
        .section_name = "sample_ext",
        .program_name = "test_map_update_element",
        .referenced_map_indices = test_map_update_element_maps,
        .referenced_map_count = 3,
        .helpers = test_map_update_element_helpers,
        .helper_count = 2,
        .bpf_instruction_count = 40,
        .program_type = &test_map_update_element_program_type_guid,
        .expected_attach_type = &test_map_update_element_attach_type_guid,
        .btf_resolved_functions = NULL,
        .btf_resolved_function_count = 0,
    },
};
