...
#line 94 "sample/decap_permit_packet.c"
    r0 &= UINT32_MAX;
    // EBPF_OP_JGT_REG pc=5 dst=r4 src=r3 offset=97 imm=0
#line 94 "sample/decap_permit_packet.c"
    if (r4 > r3) {
#line 94 "sample/decap_permit_packet.c"
        goto label_3;
...
#line 99 "sample/decap_permit_packet.c"
    ...
    //  pc=7 dst=r5 src=r0 offset=53 imm=56710
#line 99 "sample/decap_permit_packet.c"
...
#line 99 "sample/decap_permit_packet.c"
    ...
    //  pc=8 dst=r5 src=r0 offset=94 imm=8
#line 99 "sample/decap_permit_packet.c"
...
#line 100 "sample/decap_permit_packet.c"
    r5 += IMMEDIATE(34);
    // EBPF_OP_JGT_REG pc=11 dst=r5 src=r3 offset=91 imm=0
#line 100 "sample/decap_permit_packet.c"
    if (r5 > r3) {
#line 100 "sample/decap_permit_packet.c"
        goto label_3;
...
#line 106 "sample/decap_permit_packet.c"
    ...
    //  pc=13 dst=r5 src=r0 offset=89 imm=4
#line 106 "sample/decap_permit_packet.c"
    if ((uint32_t)r5 != IMMEDIATE(4)) {
#line 106 "sample/decap_permit_packet.c"
        goto label_3;
#line 106 "sample/decap_permit_packet.c"
    }
...
#line 107 "sample/decap_permit_packet.c"
    r4 += IMMEDIATE(20);
    // EBPF_OP_JGT_REG pc=19 dst=r4 src=r3 offset=83 imm=0
#line 107 "sample/decap_permit_packet.c"
    if (r4 > r3) {
#line 107 "sample/decap_permit_packet.c"
        goto label_3;
...
#line 29 "sample/decap_permit_packet.c"
    r4 += r5;
    // EBPF_OP_MOV_IMM pc=22 dst=r0 src=r0 offset=0 imm=2
#line 29 "sample/decap_permit_packet.c"
    r0 = IMMEDIATE(2);
#line 29 "sample/decap_permit_packet.c"
    r0 &= UINT32_MAX;
    // EBPF_OP_JGT_REG pc=23 dst=r4 src=r3 offset=79 imm=0
#line 29 "sample/decap_permit_packet.c"
    if (r4 > r3) {
#line 29 "sample/decap_permit_packet.c"
        goto label_3;
...
#line 29 "sample/decap_permit_packet.c"
    r5 += IMMEDIATE(14);
    // EBPF_OP_JGT_REG pc=26 dst=r5 src=r3 offset=76 imm=0
#line 29 "sample/decap_permit_packet.c"
    if (r5 > r3) {
#line 29 "sample/decap_permit_packet.c"
        goto label_3;
...
#line 38 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r4 + OFFSET(0)) = (uint8_t)r2;
    // EBPF_OP_MOV_IMM pc=55 dst=r2 src=r0 offset=0 imm=20
...
#line 41 "sample/decap_permit_packet.c"
    ...
    // EBPF_OP_MOV_REG pc=57 dst=r1 src=r0 offset=0 imm=0
#line 41 "sample/decap_permit_packet.c"
    r1 = r0;
#line 41 "sample/decap_permit_packet.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_MOV_IMM pc=58 dst=r0 src=r0 offset=0 imm=2
#line 41 "sample/decap_permit_packet.c"
    r0 = IMMEDIATE(2);
#line 41 "sample/decap_permit_packet.c"
    r0 &= UINT32_MAX;
    //  pc=59 dst=r1 src=r0 offset=43 imm=0
#line 41 "sample/decap_permit_packet.c"
...
#line 41 "sample/decap_permit_packet.c"
    ...
    // EBPF_OP_JA pc=60 dst=r0 src=r0 offset=41 imm=0
#line 41 "sample/decap_permit_packet.c"
    goto label_2;
label_1:
    // EBPF_OP_MOV64_REG pc=61 dst=r4 src=r2 offset=0 imm=0
#line 114 "sample/decap_permit_packet.c"
    r4 = r2;
    // EBPF_OP_ADD64_IMM pc=62 dst=r4 src=r0 offset=0 imm=54
#line 114 "sample/decap_permit_packet.c"
    r4 += IMMEDIATE(54);
    // EBPF_OP_JGT_REG pc=63 dst=r4 src=r3 offset=39 imm=0
#line 114 "sample/decap_permit_packet.c"
    if (r4 > r3) {
#line 114 "sample/decap_permit_packet.c"
        goto label_3;
#line 114 "sample/decap_permit_packet.c"
    ...
    // EBPF_OP_LDXB pc=64 dst=r4 src=r2 offset=20 imm=0
#line 120 "sample/decap_permit_packet.c"
    r4 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(20));
    //  pc=65 dst=r4 src=r0 offset=37 imm=41
#line 120 "sample/decap_permit_packet.c"
    if ((uint32_t)r4 != IMMEDIATE(41)) {
#line 120 "sample/decap_permit_packet.c"
        goto label_3;
#line 120 "sample/decap_permit_packet.c"
    }
    // EBPF_OP_MOV64_REG pc=66 dst=r4 src=r2 offset=0 imm=0
#line 120 "sample/decap_permit_packet.c"
    r4 = r2;
    // EBPF_OP_ADD64_IMM pc=67 dst=r4 src=r0 offset=0 imm=94
#line 120 "sample/decap_permit_packet.c"
    r4 += IMMEDIATE(94);
    // EBPF_OP_JGT_REG pc=68 dst=r4 src=r3 offset=34 imm=0
#line 120 "sample/decap_permit_packet.c"
    if (r4 > r3) {
#line 120 "sample/decap_permit_packet.c"
        goto label_3;
#line 120 "sample/decap_permit_packet.c"
    ...
    // EBPF_OP_LDXB pc=69 dst=r3 src=r2 offset=13 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(13));
    // EBPF_OP_STXB pc=70 dst=r2 src=r3 offset=53 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(53)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=71 dst=r3 src=r2 offset=12 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(12));
    // EBPF_OP_STXB pc=72 dst=r2 src=r3 offset=52 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(52)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=73 dst=r3 src=r2 offset=11 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(11));
    // EBPF_OP_STXB pc=74 dst=r2 src=r3 offset=51 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(51)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=75 dst=r3 src=r2 offset=10 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(10));
    // EBPF_OP_STXB pc=76 dst=r2 src=r3 offset=50 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(50)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=77 dst=r3 src=r2 offset=9 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(9));
    // EBPF_OP_STXB pc=78 dst=r2 src=r3 offset=49 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(49)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=79 dst=r3 src=r2 offset=8 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(8));
    // EBPF_OP_STXB pc=80 dst=r2 src=r3 offset=48 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(48)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=81 dst=r3 src=r2 offset=7 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(7));
    // EBPF_OP_STXB pc=82 dst=r2 src=r3 offset=47 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(47)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=83 dst=r3 src=r2 offset=6 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(6));
    // EBPF_OP_STXB pc=84 dst=r2 src=r3 offset=46 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(46)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=85 dst=r3 src=r2 offset=5 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(5));
    // EBPF_OP_STXB pc=86 dst=r2 src=r3 offset=45 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(45)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=87 dst=r3 src=r2 offset=4 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(4));
    // EBPF_OP_STXB pc=88 dst=r2 src=r3 offset=44 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(44)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=89 dst=r3 src=r2 offset=3 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(3));
    // EBPF_OP_STXB pc=90 dst=r2 src=r3 offset=43 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(43)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=91 dst=r3 src=r2 offset=2 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(2));
    // EBPF_OP_STXB pc=92 dst=r2 src=r3 offset=42 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(42)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=93 dst=r3 src=r2 offset=1 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(1));
    // EBPF_OP_STXB pc=94 dst=r2 src=r3 offset=41 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(41)) = (uint8_t)r3;
    // EBPF_OP_LDXB pc=95 dst=r3 src=r2 offset=0 imm=0
#line 67 "sample/decap_permit_packet.c"
    r3 = *(uint8_t*)(uintptr_t)(r2 + OFFSET(0));
    // EBPF_OP_STXB pc=96 dst=r2 src=r3 offset=40 imm=0
#line 67 "sample/decap_permit_packet.c"
    *(uint8_t*)(uintptr_t)(r2 + OFFSET(40)) = (uint8_t)r3;
    // EBPF_OP_MOV_IMM pc=97 dst=r2 src=r0 offset=0 imm=40
#line 70 "sample/decap_permit_packet.c"
    r2 = IMMEDIATE(40);
#line 70 "sample/decap_permit_packet.c"
    r2 &= UINT32_MAX;
    // EBPF_OP_CALL pc=98 dst=r0 src=r0 offset=0 imm=65536
#line 70 "sample/decap_permit_packet.c"
    r0 = runtime_context->helper_data[0].address(r1, r2, r3, r4, r5, context);
#line 70 "sample/decap_permit_packet.c"
    if ((runtime_context->helper_data[0].tail_call) && (r0 == 0)) {
...
#line 70 "sample/decap_permit_packet.c"
    ...
    // EBPF_OP_MOV_REG pc=99 dst=r1 src=r0 offset=0 imm=0
#line 70 "sample/decap_permit_packet.c"
    r1 = r0;
#line 70 "sample/decap_permit_packet.c"
    r1 &= UINT32_MAX;
    // EBPF_OP_MOV_IMM pc=100 dst=r0 src=r0 offset=0 imm=2
#line 70 "sample/decap_permit_packet.c"
    r0 = IMMEDIATE(2);
#line 70 "sample/decap_permit_packet.c"
    r0 &= UINT32_MAX;
    //  pc=101 dst=r1 src=r0 offset=1 imm=0
#line 70 "sample/decap_permit_packet.c"
    if ((int32_t)r1 < IMMEDIATE(0)) {
#line 70 "sample/decap_permit_packet.c"
        goto label_3;
...
label_2:
    // EBPF_OP_MOV_IMM pc=102 dst=r0 src=r0 offset=0 imm=1
#line 70 "sample/decap_permit_packet.c"
    r0 = IMMEDIATE(1);
#line 70 "sample/decap_permit_packet.c"
    r0 &= UINT32_MAX;
