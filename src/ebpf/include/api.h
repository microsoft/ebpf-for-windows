 ...
 */
uint32_t ebpf_api_load_program(const char *file, const char *section_name,
 ...
 *   }\n
 */
uint32_t ebpf_api_elf_enumerate_sections(const char *file, const char *section,
                                         bool verbose,
