---
description: 'Audit and repair drift between eBPF for Windows specs, code, and tests for a subsystem.'
---
...
For each finding, report using the following markdown template. This
...
**Verification**: The tests, simulations, or verification assets for the scoped subsystem.
