...
static ebpf_result_t
_ebpf_native_initialize_maps(_Out_writes_(map_count) ebpf_native_map_t* native_maps, _Inout_updates_(map_count) map_entry_t* maps, size_t map_count)
{
    ebpf_result_t result = EBPF_SUCCESS;
...
_ebpf_native_initialize_programs(
    _Out_writes_(program_count) ebpf_native_program_t* native_programs, _In_reads_(program_count) program_entry_t* programs, size_t program_count)
{
