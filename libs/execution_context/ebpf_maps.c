...
_clean_up_custom_hash_map(_Inout_ ebpf_custom_map_t* map)
{
    ...
    for (previous_key = NULL;; previous_key = next_key) {
        ...
        if (map->provider_dispatch->pre_process_map_delete_element != NULL) {
            // Call provider to notify deletion.
            map->provider_dispatch->pre_process_map_delete_element(
    ...
    int flags)
{
    ...
    if (custom_map->provider_dispatch->pre_process_map_update_element) {
        ...
        result = custom_map->provider_dispatch->pre_process_map_update_element(
    ...
    if (result != EBPF_SUCCESS && custom_map->provider_dispatch->pre_process_map_delete_element != NULL) {
        ...
        custom_map->provider_dispatch->pre_process_map_delete_element(
            custom_map->provider_context,
            custom_map->core_map.custom_map_context,
            custom_map->core_map.ebpf_map_definition.key_size,
            key,
    ...
    _In_ uint8_t* value)
{
    ...
    case EBPF_HASH_TABLE_NOTIFICATION_TYPE_FREE:
        ...
        if (custom_map->provider_dispatch->pre_process_map_delete_element != NULL) {
            result = custom_map->provider_dispatch->pre_process_map_delete_element(
                custom_map->provider_context,
                custom_map->core_map.custom_map_context,
                custom_map->core_map.ebpf_map_definition.key_size,
                key,
    ...
    _Outptr_ ebpf_core_map_t** map)
{
    ...
    *map = NULL;
    ...
    if (UPDATE_ORIGINAL_VALUE_FLAG_PRESENT(custom_map->provider_flags)) {
        if (custom_map->provider_dispatch->post_process_map_find_element == NULL ||
            custom_map->provider_dispatch->pre_process_map_update_element == NULL ||
            custom_map->provider_dispatch->pre_process_map_delete_element == NULL) {
            result = EBPF_INVALID_ARGUMENT;
            EBPF_LOG_MESSAGE_UINT64(
                EBPF_TRACELOG_LEVEL_ERROR,
                EBPF_TRACELOG_KEYWORD_MAP,
    ...
    int flags)
{
    ...
    if (provider_dispatch->post_process_map_find_element != NULL) {
        ...
        result = provider_dispatch->post_process_map_find_element(
            custom_map->provider_context,
            custom_map->core_map.custom_map_context,
            key_size,
            key,
