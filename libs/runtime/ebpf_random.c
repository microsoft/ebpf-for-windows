...
ebpf_random_initiate()
{
    ...
    _ebpf_random_number_generator_state = cxplat_allocate_cache_aligned(state_size, EBPF_POOL_TAG_RANDOM);
...
{
    cxplat_free((void*)_ebpf_random_number_generator_state, EBPF_POOL_TAG_RANDOM);
