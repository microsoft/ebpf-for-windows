    ...
    _Out_ size_t* required_length)
{
    ...
    *serialized_data_length = 0;
    ...
    helper_prototype_array = program_info->program_specific_helper_prototype;
    if (helper_prototype_array != NULL) {
        if (program_info->count_of_program_specific_helpers == 0) {
            EBPF_LOG_MESSAGE(
                EBPF_TRACELOG_LEVEL_WARNING,
                EBPF_TRACELOG_KEYWORD_BASE,
                "program_info->count_of_program_specific_helpers 0");
            result = EBPF_INVALID_ARGUMENT;
            goto Exit;
        }
        for (helper_prototype_index = 0; helper_prototype_index < program_info->count_of_program_specific_helpers;
    ...
    *serialized_data_length = *required_length;
    ...
    if (helper_prototype_array != NULL) {
        ...
        serialized_helper_prototype_array->helper_function_count = program_info->count_of_program_specific_helpers;
    ...
    _Outptr_ ebpf_program_info_t** program_info)
{
    ...
    local_program_info->count_of_program_specific_helpers = helper_function_count;
    ...
    local_program_info->program_specific_helper_prototype = local_helper_prototype_array;
