...
#define ELF____SHT_RELA ((uint8_t)4U)

#define ELF____SHT_REL ((uint8_t)9U)

#define ELF____SIZEOF_ELF64_REL ((uint8_t)16U)

#define ELF____SIZEOF_ELF64_RELA ((uint8_t)24U)
