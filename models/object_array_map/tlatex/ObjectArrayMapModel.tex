...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} ObjectArrayMapModel}\moduleRightDash\cl{}
...
\fl{ AllowReadOutsideEpoch}\al{32}{1}{%
\@y{\@s{0}%
...
\fl{}
\fl{ {\ASSUME} ObjIds \.{\subseteq} Nat}
\fl{ {\ASSUME} MaxEpoch \.{\in} Nat}
\fl{ {\ASSUME} Cardinality ( ObjIds ) \.{\geq} 2}
\fl{}
\fl{ Epochs \.{\defeq} 0 \.{\dotdot} MaxEpoch}
\fl{ NoEpoch \.{\defeq} MaxEpoch \.{+} 1}
\fl{ AllEpochVals \.{\defeq} Epochs \.{\cup} \{ NoEpoch \}}
\fl{}
\fl{ ObjStates \.{\defeq} \{\@w{Live} ,\,\@w{Retired} ,\,\@w{Freed} \}}
\fl{}
\fl{ {\VARIABLES}}
\fl{ publishedEpoch ,\,}\al{45}{2}{%
\@y{\@s{0}%
 global/published epoch (monotonic).
}%
}
\fl{ readerEpoch ,\,}\al{46}{2}{%
\@y{\@s{0}%
...
\fl{}
\fl{ TypeOK \.{\defeq}}
\fl{ \.{\land}}\al{53}{1}{ publishedEpoch \.{\in} Epochs}
\fl{ \.{\land}}\al{54}{1}{ readerEpoch \.{\in} AllEpochVals}
 \fl{ \.{\land}}\al{55}{1}{ slot}\al{55}{2}{ \.{\in}}\al{55}{3}{ (
 ObjIds}\al{55}{5}{ \.{\cup}}\al{55}{6}{ \{ 0 \} )}
 \fl{ \.{\land}}\al{56}{1}{ held}\al{56}{2}{ \.{\in}}\al{56}{3}{ (
 ObjIds}\al{56}{5}{ \.{\cup}}\al{56}{6}{ \{ 0 \} )}
 \fl{ \.{\land}}\al{57}{1}{ objState \.{\in} [ ObjIds \.{\rightarrow}
 ObjStates ]}
 \fl{ \.{\land}}\al{58}{1}{ retireEpoch \.{\in} [ ObjIds \.{\rightarrow}
 AllEpochVals ]}
\fl{}
\fl{ Safety \.{\defeq}}
\fl{ \.{\land} held \.{=} 0 \.{\lor} objState [ held ] \.{\neq}\@w{Freed}}
\fl{}
\fl{ Init \.{\defeq}}
 \fl{ \.{\LET}}\al{64}{1}{ o1}\al{64}{2}{ \.{\defeq}}\al{64}{3}{ {\CHOOSE}
 o}\al{64}{5}{ \.{\in}}\al{64}{6}{ ObjIds \.{:} {\TRUE}}
 \fl{ o2}\al{65}{1}{ \.{\defeq}}\al{65}{2}{ {\CHOOSE} o}\al{65}{4}{
 \.{\in}}\al{65}{5}{ ( ObjIds \.{\,\backslash\,} \{ o1 \} ) \.{:} {\TRUE}}
\fl{ \.{\IN}}
\fl{ \.{\land}}\al{67}{1}{ publishedEpoch \.{=} 0}
\fl{ \.{\land}}\al{68}{1}{ readerEpoch \.{=} NoEpoch}
\fl{ \.{\land}}\al{69}{1}{ slot}\al{69}{2}{ \.{=}}\al{69}{3}{ o1}
\fl{ \.{\land}}\al{70}{1}{ held}\al{70}{2}{ \.{=}}\al{70}{3}{ 0}
 \fl{ \.{\land}}\al{71}{1}{ objState \.{=} [ o \.{\in} ObjIds \.{\mapsto}
 {\IF} o \.{=} o1 \.{\THEN}\@w{Live} \.{\ELSE}\@w{Freed} ]}
 \fl{ \.{\land}}\al{72}{1}{ retireEpoch \.{=} [ o \.{\in} ObjIds \.{\mapsto}
 NoEpoch ]}
\fl{}
\fl{}
\fl{ ReaderEnter \.{\defeq}}
\fl{ \.{\land}}\al{76}{1}{ readerEpoch \.{=} NoEpoch}
\fl{ \.{\land}}\al{77}{1}{ readerEpoch \.{'} \.{=} publishedEpoch}
 \fl{ \.{\land}}\al{78}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\, slot ,\,
 objState ,\, retireEpoch ,\, held {\rangle}}
\fl{}
\fl{ ReaderExit \.{\defeq}}
\fl{ \.{\land}}\al{81}{1}{ readerEpoch \.{\neq} NoEpoch}
\fl{ \.{\land}}\al{82}{1}{ held \.{=} 0}
\fl{ \.{\land}}\al{83}{1}{ readerEpoch \.{'} \.{=} NoEpoch}
 \fl{ \.{\land}}\al{84}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\, slot ,\,
 objState ,\, retireEpoch ,\, held {\rangle}}
\fl{}
\fl{ ReaderLoad \.{\defeq}}
\fl{ \.{\land}}\al{87}{1}{ held}\al{87}{2}{ \.{=}}\al{87}{3}{ 0}
\fl{ \.{\land}}\al{88}{1}{ slot}\al{88}{2}{ \.{\neq}}\al{88}{3}{ 0}
 \fl{ \.{\land}}\al{89}{1}{ ( AllowReadOutsideEpoch \.{\lor} readerEpoch
 \.{\neq} NoEpoch )}
\fl{ \.{\land}}\al{90}{1}{ held \.{'} \.{=} slot}
 \fl{ \.{\land}}\al{91}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\,
 readerEpoch ,\, slot ,\, objState ,\, retireEpoch {\rangle}}
\fl{}
\fl{ ReaderDrop \.{\defeq}}
\fl{ \.{\land}}\al{94}{1}{ held \.{\neq} 0}
\fl{ \.{\land}}\al{95}{1}{ held \.{'} \.{=} 0}
 \fl{ \.{\land}}\al{96}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\,
 readerEpoch ,\, slot ,\, objState ,\, retireEpoch {\rangle}}
\fl{}
\fl{}
\fl{ AllocateNewLiveObject \.{\defeq}}
\fl{ {\CHOOSE} o \.{\in} ObjIds \.{:} objState [ o ] \.{=}\@w{Freed}}
\fl{}
\fl{ WriterUpdate \.{\defeq}}
\fl{ \.{\land}}\al{103}{1}{ slot \.{\neq} 0}
\fl{ \.{\land}}\al{104}{1}{ \E\, new \.{\in} ObjIds \.{:}}
\fl{ \.{\land}}\al{105}{1}{ objState [ new ] \.{=}\@w{Freed}}
\fl{ \.{\land}}\al{106}{1}{ slot \.{'} \.{=} new}
 \fl{ \.{\land}}\al{107}{1}{ objState \.{'} \.{=} [}\al{107}{5}{ objState
 {\EXCEPT}}
\fl{ {\bang}}\al{108}{1}{ [ slot ] \.{=}\@w{Retired} ,\,}
\fl{ {\bang}}\al{109}{1}{ [ new ] \.{=}\@w{Live} ]}
 \fl{ \.{\land}}\al{110}{1}{ retireEpoch \.{'} \.{=} [ retireEpoch {\EXCEPT}
 {\bang} [ slot ] \.{=} publishedEpoch ]}
 \fl{ \.{\land}}\al{111}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\,
 readerEpoch ,\, held {\rangle}}
\fl{}
\fl{}
\fl{ AdvanceEpoch \.{\defeq}}
\fl{ \.{\land}}\al{115}{1}{ publishedEpoch \.{<} MaxEpoch}
\fl{ \.{\land}}\al{116}{1}{ publishedEpoch \.{'} \.{=} publishedEpoch \.{+} 1}
 \fl{ \.{\land}}\al{117}{1}{ {\UNCHANGED} {\langle} readerEpoch ,\, slot ,\,
 objState ,\, retireEpoch ,\, held {\rangle}}
\fl{}
 \fl{ MinActiveEpoch \.{\defeq} {\IF} readerEpoch \.{=} NoEpoch \.{\THEN}
 NoEpoch \.{\ELSE} readerEpoch}
\fl{}
\fl{ CanReclaim ( o ) \.{\defeq}}
\fl{ \.{\land}}\al{122}{1}{ objState [ o ] \.{=}\@w{Retired}}
\fl{ \.{\land}}\al{123}{1}{ retireEpoch [ o ]}\al{123}{5}{ \.{\in} Epochs}
 \fl{ \.{\land}}\al{124}{1}{ retireEpoch [ o ]}\al{124}{5}{ \.{<}
 MinActiveEpoch}
\fl{}
\fl{ ReclaimOne \.{\defeq}}
\fl{ \.{\land}}\al{127}{1}{ \E\, o \.{\in} ObjIds \.{:} CanReclaim ( o )}
 \fl{ \.{\land}}\al{128}{1}{ \.{\LET} o \.{\defeq} {\CHOOSE} x \.{\in} ObjIds
 \.{:} CanReclaim ( x )}
\fl{ \.{\IN}}
 \fl{ \.{\land}}\al{130}{1}{ objState \.{'} \.{=} [ objState {\EXCEPT} {\bang}
 [ o ] \.{=}\@w{Freed} ]}
 \fl{ \.{\land}}\al{131}{1}{ retireEpoch \.{'} \.{=} [ retireEpoch {\EXCEPT}
 {\bang} [ o ] \.{=} NoEpoch ]}
 \fl{ \.{\land}}\al{132}{1}{ {\UNCHANGED} {\langle} publishedEpoch ,\,
 readerEpoch ,\, slot ,\, held {\rangle}}
\fl{}
 \fl{ vars}\al{134}{1}{ \.{\defeq} {\langle} publishedEpoch ,\, readerEpoch
 ,\, slot ,\, objState ,\, retireEpoch ,\, held {\rangle}}
\fl{}
\fl{ Next}\al{136}{1}{ \.{\defeq}}
\fl{ ReaderEnter}
\fl{ \.{\lor}}\al{138}{1}{ ReaderExit}
\fl{ \.{\lor}}\al{139}{1}{ ReaderLoad}
\fl{ \.{\lor}}\al{140}{1}{ ReaderDrop}
\fl{ \.{\lor}}\al{141}{1}{ WriterUpdate}
\fl{ \.{\lor}}\al{142}{1}{ AdvanceEpoch}
\fl{ \.{\lor}}\al{143}{1}{ ReclaimOne}
\fl{}
