...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} ExtensionInvokeModel}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals ,\, TLC}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{ {\ASSUME} EpochEnterIsBarrier \.{\in} {\BOOLEAN}}
\fl{}
\fl{ Ptr \.{\defeq} \{ 0 ,\, 1 \}}
\fl{}
\fl{ {\VARIABLES}}
...
\fl{ stale\_ptr ,\,}\al{38}{2}{%
\@y{\@s{0}%
 last seen value of \ensuremath{ext\_ptr} (models a potentially stale cached
 value)
}%
}
\fl{ ext\_alive ,\,}\al{39}{2}{%
\@y{\@s{0}%
 \ensuremath{{\TRUE}} if the pointed-to data is still valid (not freed)
}%
}
\fl{ inv\_in\_epoch ,\,}\al{40}{2}{%
\@y{\@s{0}%
 invoker is executing inside an epoch
}%
}
\fl{ inv\_barrier ,\,}\al{41}{2}{%
\@y{\@s{0}%
 whether the invoker has executed an ordering barrier
}%
}
\fl{ inv\_loaded\_ptr ,\,}\al{42}{2}{%
\@y{\@s{0}%
 value read by \ensuremath{ReadPointerNoFence
}}%
}
\fl{ inv\_using}\al{43}{1}{%
\@y{\@s{0}%
 invoker is using the extension program data
}%
}
\fl{}
 \fl{ Vars \.{\defeq} {\langle} ext\_ptr ,\, stale\_ptr ,\, ext\_alive ,\,
 inv\_in\_epoch ,\, inv\_barrier ,\, inv\_loaded\_ptr ,\, inv\_using
 {\rangle}}
\fl{}
\fl{ TypeOK \.{\defeq}}
\fl{ \.{\land}}\al{48}{1}{ ext\_ptr \.{\in} Ptr}
\fl{ \.{\land}}\al{49}{1}{ stale\_ptr}\al{49}{2}{ \.{\in}}\al{49}{3}{ Ptr}
 \fl{ \.{\land}}\al{50}{1}{ ext\_alive}\al{50}{2}{ \.{\in}}\al{50}{3}{
 {\BOOLEAN}}
\fl{ \.{\land}}\al{51}{1}{ inv\_in\_epoch \.{\in} {\BOOLEAN}}
\fl{ \.{\land}}\al{52}{1}{ inv\_barrier \.{\in} {\BOOLEAN}}
\fl{ \.{\land}}\al{53}{1}{ inv\_loaded\_ptr \.{\in} Ptr}
\fl{ \.{\land}}\al{54}{1}{ inv\_using \.{\in} {\BOOLEAN}}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ Init}\al{59}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{60}{1}{ ext\_ptr \.{=} 1}
\fl{ \.{\land}}\al{61}{1}{ stale\_ptr}\al{61}{2}{ \.{=}}\al{61}{3}{ 1}
\fl{ \.{\land}}\al{62}{1}{ ext\_alive}\al{62}{2}{ \.{=}}\al{62}{3}{ {\TRUE}}
\fl{ \.{\land}}\al{63}{1}{ inv\_in\_epoch \.{=} {\FALSE}}
\fl{ \.{\land}}\al{64}{1}{ inv\_barrier \.{=} {\FALSE}}
\fl{ \.{\land}}\al{65}{1}{ inv\_loaded\_ptr \.{=} 0}
\fl{ \.{\land}}\al{66}{1}{ inv\_using \.{=} {\FALSE}}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ DetachClear \.{\defeq}}
\fl{ \.{\land}}\al{76}{1}{ ext\_ptr \.{=} 1}
\fl{ \.{\land}}\al{77}{1}{ ext\_ptr \.{'} \.{=} 0}
\fl{ \.{\land}}\al{78}{1}{ stale\_ptr \.{'} \.{=} ext\_ptr}
 \fl{ \.{\land}}\al{79}{1}{ {\UNCHANGED} {\langle} ext\_alive ,\,
 inv\_in\_epoch ,\, inv\_barrier ,\, inv\_loaded\_ptr ,\, inv\_using
 {\rangle}}
\fl{}
\fl{ DetachFree \.{\defeq}}
\fl{ \.{\land}}\al{82}{1}{ ext\_ptr \.{=} 0}
\fl{ \.{\land}}\al{83}{1}{ ext\_alive \.{=} {\TRUE}}
\fl{ \.{\land}}\al{84}{1}{ inv\_in\_epoch \.{=} {\FALSE}}
\fl{ \.{\land}}\al{85}{1}{ ext\_alive \.{'} \.{=} {\FALSE}}
 \fl{ \.{\land}}\al{86}{1}{ {\UNCHANGED} {\langle} ext\_ptr ,\, stale\_ptr ,\,
 inv\_in\_epoch ,\, inv\_barrier ,\, inv\_loaded\_ptr ,\, inv\_using
 {\rangle}}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ InvokerEnterEpoch \.{\defeq}}
\fl{ \.{\land}}\al{100}{1}{ inv\_in\_epoch \.{=} {\FALSE}}
\fl{ \.{\land}}\al{101}{1}{ inv\_in\_epoch \.{'} \.{=} {\TRUE}}
\fl{ \.{\land}}\al{102}{1}{ inv\_barrier \.{'} \.{=} EpochEnterIsBarrier}
 \fl{ \.{\land}}\al{103}{1}{ {\UNCHANGED} {\langle} ext\_ptr ,\, stale\_ptr
 ,\, ext\_alive ,\, inv\_loaded\_ptr ,\, inv\_using {\rangle}}
\fl{}
\fl{ InvokerReadPointerNoFence \.{\defeq}}
\fl{ \.{\land}}\al{106}{1}{ inv\_in\_epoch \.{=} {\TRUE}}
\fl{ \.{\land}}\al{107}{1}{ inv\_loaded\_ptr \.{=} 0}
\fl{ \.{\land}}\al{108}{1}{ inv\_using \.{=} {\FALSE}}
\fl{ \.{\land}}\al{109}{1}{ {\IF}}\al{109}{2}{ inv\_barrier}
\fl{ \.{\THEN} inv\_loaded\_ptr \.{'}}\al{110}{3}{ \.{=} ext\_ptr}
 \fl{ \.{\ELSE} inv\_loaded\_ptr \.{'}}\al{111}{3}{ \.{\in} \{ ext\_ptr ,\,
 stale\_ptr \}}
 \fl{ \.{\land}}\al{112}{1}{ {\UNCHANGED} {\langle} ext\_ptr ,\, stale\_ptr
 ,\, ext\_alive ,\, inv\_in\_epoch ,\, inv\_barrier ,\, inv\_using {\rangle}}
\fl{}
\fl{ InvokerUse \.{\defeq}}
\fl{ \.{\land}}\al{115}{1}{ inv\_in\_epoch \.{=} {\TRUE}}
\fl{ \.{\land}}\al{116}{1}{ inv\_loaded\_ptr \.{=} 1}
\fl{ \.{\land}}\al{117}{1}{ inv\_using \.{=} {\FALSE}}
\fl{ \.{\land}}\al{118}{1}{ inv\_using \.{'} \.{=} {\TRUE}}
 \fl{ \.{\land}}\al{119}{1}{ {\UNCHANGED} {\langle} ext\_ptr ,\, stale\_ptr
 ,\, ext\_alive ,\, inv\_in\_epoch ,\, inv\_barrier ,\, inv\_loaded\_ptr
 {\rangle}}
\fl{}
\fl{ InvokerFinish \.{\defeq}}
\fl{ \.{\land}}\al{122}{1}{ inv\_in\_epoch \.{=} {\TRUE}}
\fl{ \.{\land}}\al{123}{1}{ inv\_using \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{124}{1}{ inv\_loaded\_ptr \.{'} \.{=} 0}
\fl{ \.{\land}}\al{125}{1}{ inv\_in\_epoch \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{126}{1}{ inv\_barrier \.{'} \.{=} {\FALSE}}
 \fl{ \.{\land}}\al{127}{1}{ {\UNCHANGED} {\langle} ext\_ptr ,\, stale\_ptr
 ,\, ext\_alive {\rangle}}
\fl{}
\fl{ Next \.{\defeq}}
\fl{ DetachClear}
\fl{ \.{\lor}}\al{131}{1}{ DetachFree}
\fl{ \.{\lor}}\al{132}{1}{ InvokerEnterEpoch}
\fl{ \.{\lor}}\al{133}{1}{ InvokerReadPointerNoFence}
\fl{ \.{\lor}}\al{134}{1}{ InvokerUse}
\fl{ \.{\lor}}\al{135}{1}{ InvokerFinish}
\fl{}
...
\fl{}
\fl{}
\fl{ Safety \.{\defeq} inv\_using \.{\implies} ext\_alive}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
