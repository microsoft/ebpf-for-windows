...
\@x{}%
\@y{\@s{0}%
 Useful strengthening that is true in both fixed and buggy configs.
}%
\@xx{}%
...
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, Init ,\, TypeOK ,\, CPUS ,\,
 ObjStates}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} InitImpliesRetireStampIsMaxWhenEnabled \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
\@x{\@s{8.2} {\PROVE} Init \.{\implies} RetireStampIsMaxWhenEnabled}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, Init ,\,
 RetireStampIsMaxWhenEnabled ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByAdvanceEpoch \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} RetireStampIsMaxWhenEnabled \.{\land} AdvanceEpoch
 \.{\implies} RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 AdvanceEpoch ,\, Max2}%
\@pvspace{8.0pt}%
 \@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByProcessEpochUpdate
 \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ( \E\, c
 \.{\in} CPUS \.{\,\backslash\,} \{ 0 \} \.{:} ProcessEpochUpdate ( c ) ) )
 \.{\implies} RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 ProcessEpochUpdate ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByReaderEnter \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ( \E\, c
 \.{\in} CPUS \.{:} ReaderEnter ( c ) ) ) \.{\implies}
 RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 ReaderEnter ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByReaderRead \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ( \E\, c
 \.{\in} CPUS \.{:} ReaderRead ( c ) ) ) \.{\implies}
 RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 ReaderRead ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByReaderExit \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ( \E\, c
 \.{\in} CPUS \.{:} ReaderExit ( c ) ) ) \.{\implies}
 RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 ReaderExit ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByRetire \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ( \E\, c
 \.{\in} CPUS \.{:} Retire ( c ) ) ) \.{\implies} RetireStampIsMaxWhenEnabled
 \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 Retire ,\, Max2}%
\@pvspace{8.0pt}%
 \@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByComputeRelease
 \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} ComputeRelease
 ) \.{\implies} RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 ComputeRelease ,\, Max2}%
\@pvspace{8.0pt}%
\@x{ {\LEMMA} RetireStampIsMaxWhenEnabledPreservedByReclaim \.{\defeq}}%
\@x{\@s{8.2} {\ASSUME}}%
\@x{\@s{16.4} CfgAssumptions}%
 \@x{\@s{8.2} {\PROVE} ( RetireStampIsMaxWhenEnabled \.{\land} Reclaim )
 \.{\implies} RetireStampIsMaxWhenEnabled \.{'}}%
\@x{ {\PROOF}}%
 \@x{\@s{8.2} {\BY} {\DEF} CfgAssumptions ,\, RetireStampIsMaxWhenEnabled ,\,
 Reclaim ,\, Max2}%
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{TODO}: \ensuremath{ReleaseNeverAhead} preservation (requires
 \ensuremath{Min}/finite-set reasoning).
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ FixedInv \.{\defeq}}%
...
\@x{\@s{36.21} CfgAssumptions ,\,}%
 \@x{\@s{36.21} Init ,\, TypeOK ,\, RetireStampIsMaxWhenEnabled ,\,
 ReleaseNeverAhead ,\,}%
 \@x{\@s{36.21} ReaderEpochNeverAhead ,\, HolderEpochBoundedByRetire ,\,
 Safety ,\,}%
\@x{\@s{36.21} CPUS ,\, ObjStates ,\, Max2}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Next step: discharge \ensuremath{FixedInv \.{\land} Next \.{\implies}
 FixedInv\.{'}}.
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{TODO}: \ensuremath{FixedInv \.{\land} Next \.{\implies}
 FixedInv\.{'}} (this is where the real \ensuremath{Safety} proof work lives).
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
