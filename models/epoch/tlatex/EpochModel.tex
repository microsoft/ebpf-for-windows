...
\@x{ {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Max2 ( a ,\, b )\@s{3.47} \.{\defeq} {\IF} a \.{\geq} b \.{\THEN} a
 \.{\ELSE} b}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} \E\, candidate \.{\in} 0 \.{\dotdot} MaxEpoch \.{:}}%
\@x{\@s{31.61} \.{\land} candidate \.{\leq} ( published\_epoch \.{-} 1 )}%
 \@x{\@s{31.61} \.{\land} \A\, c \.{\in} ActiveCPUs \.{:} candidate \.{<}
 reader\_epoch [ c ]}%
 \@x{\@s{31.61} \.{\land} released\_epoch \.{'} \.{=} Max2 ( released\_epoch
 ,\, candidate )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} published\_epoch ,\,
