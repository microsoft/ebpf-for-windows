...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} RingBufferModel}\moduleRightDash\cl{}
...
\fl{}
\fl{ {\ASSUME} Capacity \.{\in} Nat}
\fl{ {\ASSUME} MaxOffset \.{\in} Nat}
\fl{ {\ASSUME} MaxLiveRecords \.{\in} Nat}
\fl{ {\ASSUME} Sizes \.{\subseteq} Nat}
\fl{ {\ASSUME} \A\, s \.{\in} Sizes \.{:} s \.{>} 0}
\fl{}
 \fl{ States}\al{38}{1}{ \.{\defeq}}\al{38}{2}{ \{\@w{Uninit} ,\,\@w{Locked}
 ,\,\@w{Submitted} ,\,\@w{Discarded} \}}
\fl{}
 \fl{ Record}\al{40}{1}{ \.{\defeq}}\al{40}{2}{ [ size \.{:} Sizes ,\, state
 \.{:} States ]}
\fl{}
\fl{ {\VARIABLES}}
\fl{ consumer ,\,}\al{43}{2}{%
...
\fl{}
 \fl{ Held \.{\defeq} [ active \.{:} {\BOOLEAN} ,\, size \.{:} 0 \.{\dotdot}
 MaxOffset ,\, state \.{:} States ]}
\fl{}
\fl{ TypeOK \.{\defeq}}
 \fl{ \.{\land}}\al{57}{1}{ consumer}\al{57}{2}{ \.{\in}}\al{57}{3}{ 0
 \.{\dotdot} MaxOffset}
 \fl{ \.{\land}}\al{58}{1}{ producer}\al{58}{2}{ \.{\in}}\al{58}{3}{ 0
 \.{\dotdot} MaxOffset}
\fl{ \.{\land}}\al{59}{1}{ reserve \.{\in} 0 \.{\dotdot} MaxOffset}
\fl{ \.{\land}}\al{60}{1}{ liveSize \.{\in} 0 \.{\dotdot} Capacity}
\fl{ \.{\land}}\al{61}{1}{ records \.{\in} Seq ( Record )}
\fl{ \.{\land}}\al{62}{1}{ Len ( records ) \.{\leq} MaxLiveRecords}
\fl{ \.{\land}}\al{63}{1}{ held \.{\in} Held}
\fl{ \.{\land}}\al{64}{1}{ asyncPending \.{\in} {\BOOLEAN}}
\fl{ \.{\land}}\al{65}{1}{ asyncCompleted \.{\in} {\BOOLEAN}}
 \fl{ \.{\land}}\al{66}{1}{ asyncResult \.{\in} [ consumer \.{:} 0 \.{\dotdot}
 MaxOffset ,\, producer \.{:} 0 \.{\dotdot} MaxOffset ]}
\fl{ \.{\land}}\al{67}{1}{ tripWire \.{\in} {\BOOLEAN}}
\fl{}
\fl{ OffsetsConsistent \.{\defeq}}
\fl{ \.{\land}}\al{70}{1}{ consumer \.{\leq} producer}
\fl{ \.{\land}}\al{71}{1}{ producer \.{\leq} reserve}
\fl{ \.{\land}}\al{72}{1}{ reserve \.{=} consumer \.{+} liveSize}
\fl{ \.{\land}}\al{73}{1}{ liveSize \.{\leq} Capacity}
\fl{}
\fl{ Safety \.{\defeq}}
\fl{}
\fl{ held . active \.{\implies} held . state \.{=}\@w{Submitted}}
\fl{}
\fl{ Init}\al{79}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{80}{1}{ consumer}\al{80}{2}{ \.{=}}\al{80}{3}{ 0}
\fl{ \.{\land}}\al{81}{1}{ producer}\al{81}{2}{ \.{=}}\al{81}{3}{ 0}
\fl{ \.{\land}}\al{82}{1}{ reserve \.{=} 0}
\fl{ \.{\land}}\al{83}{1}{ liveSize \.{=} 0}
\fl{ \.{\land}}\al{84}{1}{ records \.{=} {\langle} {\rangle}}
 \fl{ \.{\land}}\al{85}{1}{ held \.{=} [ active \.{\mapsto} {\FALSE} ,\, size
 \.{\mapsto} 0 ,\, state \.{\mapsto}\@w{Locked} ]}
\fl{ \.{\land}}\al{86}{1}{ asyncPending \.{=} {\FALSE}}
\fl{ \.{\land}}\al{87}{1}{ asyncCompleted \.{=} {\FALSE}}
 \fl{ \.{\land}}\al{88}{1}{ asyncResult \.{=} [ consumer \.{\mapsto} 0 ,\,
 producer \.{\mapsto} 0 ]}
\fl{ \.{\land}}\al{89}{1}{ tripWire \.{=} {\FALSE}}
\fl{}
\fl{ CanReserve ( sz ) \.{\defeq}}
\fl{ \.{\land}}\al{92}{1}{ sz \.{\in} Sizes}
\fl{ \.{\land}}\al{93}{1}{ liveSize \.{+} sz \.{\leq} Capacity}
\fl{ \.{\land}}\al{94}{1}{ reserve \.{+} sz \.{\leq} MaxOffset}
\fl{ \.{\land}}\al{95}{1}{ Len ( records ) \.{<} MaxLiveRecords}
\fl{}
\fl{ ProducerReserve \.{\defeq}}
\fl{ \E\, sz \.{\in} Sizes \.{:}}
\fl{ \.{\land}}\al{99}{1}{ CanReserve ( sz )}
\fl{ \.{\land}}\al{100}{1}{ {\lnot} BuggyPublishBeforeLock}
 \fl{ \.{\land}}\al{101}{1}{ records \.{'}}\al{101}{3}{ \.{=}}\al{101}{4}{
 Append ( records ,\, [ size \.{\mapsto} sz ,\, state \.{\mapsto}\@w{Locked}
 ] )}
 \fl{ \.{\land}}\al{102}{1}{ reserve \.{'}}\al{102}{3}{ \.{=}}\al{102}{4}{
 reserve \.{+} sz}
 \fl{ \.{\land}}\al{103}{1}{ producer \.{'}}\al{103}{3}{ \.{=}}\al{103}{4}{
 reserve \.{'}}
 \fl{ \.{\land}}\al{104}{1}{ liveSize \.{'}}\al{104}{3}{ \.{=}}\al{104}{4}{
 liveSize \.{+} sz}
 \fl{ \.{\land}}\al{105}{1}{ {\UNCHANGED} {\langle} consumer ,\, held ,\,
 asyncPending ,\, asyncCompleted ,\, asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ProducerReserveBuggyPublish \.{\defeq}}
\fl{ \E\, sz \.{\in} Sizes \.{:}}
\fl{ \.{\land}}\al{109}{1}{ CanReserve ( sz )}
\fl{ \.{\land}}\al{110}{1}{ BuggyPublishBeforeLock}
\fl{}
 \fl{ \.{\land}}\al{112}{1}{ records \.{'}}\al{112}{3}{ \.{=}}\al{112}{4}{
 Append ( records ,\, [ size \.{\mapsto} sz ,\, state \.{\mapsto}\@w{Uninit}
 ] )}
 \fl{ \.{\land}}\al{113}{1}{ reserve \.{'}}\al{113}{3}{ \.{=}}\al{113}{4}{
 reserve \.{+} sz}
 \fl{ \.{\land}}\al{114}{1}{ producer \.{'}}\al{114}{3}{ \.{=}}\al{114}{4}{
 reserve \.{'}}
 \fl{ \.{\land}}\al{115}{1}{ liveSize \.{'}}\al{115}{3}{ \.{=}}\al{115}{4}{
 liveSize \.{+} sz}
 \fl{ \.{\land}}\al{116}{1}{ {\UNCHANGED} {\langle} consumer ,\, held ,\,
 asyncPending ,\, asyncCompleted ,\, asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ProducerFinalizeLock \.{\defeq}}
\fl{ \.{\land}}\al{119}{1}{ BuggyPublishBeforeLock}
\fl{ \.{\land}}\al{120}{1}{ Len ( records ) \.{>} 0}
\fl{ \.{\land}}\al{121}{1}{ Head ( records ) . state \.{=}\@w{Uninit}}
 \fl{ \.{\land}}\al{122}{1}{ records \.{'} \.{=} {\langle} [ size \.{\mapsto}
 Head ( records ) . size ,\, state \.{\mapsto}\@w{Locked} ] {\rangle}
 \.{\circ} Tail ( records )}
 \fl{ \.{\land}}\al{123}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, held ,\, asyncPending ,\, asyncCompleted ,\,
 asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ProducerSubmit \.{\defeq}}
\fl{ \.{\land}}\al{126}{1}{ Len ( records ) \.{>} 0}
\fl{ \.{\land}}\al{127}{1}{ Head ( records ) . state \.{=}\@w{Locked}}
 \fl{ \.{\land}}\al{128}{1}{ records \.{'} \.{=} {\langle} [ size \.{\mapsto}
 Head ( records ) . size ,\, state \.{\mapsto}\@w{Submitted} ] {\rangle}
 \.{\circ} Tail ( records )}
 \fl{ \.{\land}}\al{129}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, held ,\, asyncPending ,\, asyncCompleted ,\,
 asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ProducerDiscard \.{\defeq}}
\fl{ \.{\land}}\al{132}{1}{ Len ( records ) \.{>} 0}
\fl{ \.{\land}}\al{133}{1}{ Head ( records ) . state \.{=}\@w{Locked}}
 \fl{ \.{\land}}\al{134}{1}{ records \.{'} \.{=} {\langle} [ size \.{\mapsto}
 Head ( records ) . size ,\, state \.{\mapsto}\@w{Discarded} ] {\rangle}
 \.{\circ} Tail ( records )}
 \fl{ \.{\land}}\al{135}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, held ,\, asyncPending ,\, asyncCompleted ,\,
 asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ConsumerNext \.{\defeq}}
\fl{ \.{\land}}\al{138}{1}{ held . active \.{=} {\FALSE}}
\fl{ \.{\land}}\al{139}{1}{ Len ( records ) \.{>} 0}
 \fl{ \.{\land}}\al{140}{1}{ {\IF} Head ( records ) . state \.{=}\@w{Locked}
 \.{\THEN}}
\fl{}
 \fl{ {\UNCHANGED} {\langle} consumer ,\, producer ,\, reserve ,\, liveSize
 ,\, records ,\, held ,\, asyncPending ,\, asyncCompleted ,\, asyncResult ,\,
 tripWire {\rangle}}
\fl{ \.{\ELSE} {\IF} Head ( records ) . state \.{=}\@w{Discarded} \.{\THEN}}
\fl{}
 \fl{ \.{\land}}\al{145}{1}{ consumer \.{'}}\al{145}{3}{ \.{=}}\al{145}{4}{
 consumer}\al{145}{5}{ \.{+}}\al{145}{6}{ Head ( records ) . size}
 \fl{ \.{\land}}\al{146}{1}{ liveSize \.{'}}\al{146}{3}{ \.{=}}\al{146}{4}{
 liveSize}\al{146}{5}{ \.{-}}\al{146}{6}{ Head ( records ) . size}
\fl{ \.{\land}}\al{147}{1}{ records \.{'} \.{=} Tail ( records )}
 \fl{ \.{\land}}\al{148}{1}{ {\UNCHANGED} {\langle} producer ,\, reserve ,\,
 held ,\, asyncPending ,\, asyncCompleted ,\, asyncResult ,\, tripWire
 {\rangle}}
\fl{ \.{\ELSE}}
\fl{}
 \fl{ \.{\land}}\al{151}{1}{ held \.{'} \.{=} [ active \.{\mapsto} {\TRUE} ,\,
 size \.{\mapsto} Head ( records ) . size ,\, state \.{\mapsto} Head (
 records ) . state ]}
 \fl{ \.{\land}}\al{152}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, records ,\, asyncPending ,\, asyncCompleted ,\,
 asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ ConsumerReturn \.{\defeq}}
\fl{ \.{\land}}\al{155}{1}{ held . active \.{=} {\TRUE}}
\fl{ \.{\land}}\al{156}{1}{ Len ( records ) \.{>} 0}
\fl{ \.{\land}}\al{157}{1}{ Head ( records ) . size \.{=} held . size}
\fl{ \.{\land}}\al{158}{1}{ Head ( records ) . state \.{=} held . state}
 \fl{ \.{\land}}\al{159}{1}{ consumer \.{'}}\al{159}{3}{ \.{=}}\al{159}{4}{
 consumer}\al{159}{5}{ \.{+}}\al{159}{6}{ held . size}
 \fl{ \.{\land}}\al{160}{1}{ liveSize \.{'}}\al{160}{3}{ \.{=}}\al{160}{4}{
 liveSize}\al{160}{5}{ \.{-}}\al{160}{6}{ held . size}
\fl{ \.{\land}}\al{161}{1}{ records \.{'} \.{=} Tail ( records )}
 \fl{ \.{\land}}\al{162}{1}{ held \.{'} \.{=} [ active \.{\mapsto} {\FALSE}
 ,\, size \.{\mapsto} 0 ,\, state \.{\mapsto}\@w{Locked} ]}
 \fl{ \.{\land}}\al{163}{1}{ {\UNCHANGED} {\langle} producer ,\, reserve ,\,
 asyncPending ,\, asyncCompleted ,\, asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ AsyncQuery \.{\defeq}}
\fl{ \.{\land}}\al{166}{1}{ asyncPending \.{=} {\FALSE}}
\fl{ \.{\land}}\al{167}{1}{ asyncPending \.{'} \.{=} {\TRUE}}
\fl{ \.{\land}}\al{168}{1}{ tripWire \.{'} \.{=} {\TRUE}}
 \fl{ \.{\land}}\al{169}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, records ,\, held ,\, asyncCompleted ,\, asyncResult
 {\rangle}}
\fl{}
\fl{ AsyncCancel \.{\defeq}}
\fl{ \.{\land}}\al{172}{1}{ asyncPending \.{=} {\TRUE}}
\fl{ \.{\land}}\al{173}{1}{ asyncPending \.{'} \.{=} {\FALSE}}
 \fl{ \.{\land}}\al{174}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, records ,\, held ,\, asyncCompleted ,\, asyncResult
 ,\, tripWire {\rangle}}
\fl{}
\fl{ AsyncComplete \.{\defeq}}
\fl{ \.{\land}}\al{177}{1}{ asyncPending \.{=} {\TRUE}}
\fl{ \.{\land}}\al{178}{1}{ producer \.{>} consumer}
\fl{ \.{\land}}\al{179}{1}{ asyncPending \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{180}{1}{ asyncCompleted \.{'} \.{=} {\TRUE}}
 \fl{ \.{\land}}\al{181}{1}{ asyncResult \.{'} \.{=} [ consumer \.{\mapsto}
 consumer ,\, producer \.{\mapsto} producer ]}
 \fl{ \.{\land}}\al{182}{1}{ {\UNCHANGED} {\langle} consumer ,\, producer ,\,
 reserve ,\, liveSize ,\, records ,\, held ,\, tripWire {\rangle}}
\fl{}
 \fl{ vars}\al{184}{1}{ \.{\defeq} {\langle} consumer ,\, producer ,\, reserve
 ,\, liveSize ,\, records ,\, held ,\, asyncPending ,\, asyncCompleted ,\,
 asyncResult ,\, tripWire {\rangle}}
\fl{}
\fl{ Next}\al{186}{1}{ \.{\defeq}}
\fl{ ProducerReserve}
\fl{ \.{\lor}}\al{188}{1}{ ProducerReserveBuggyPublish}
\fl{ \.{\lor}}\al{189}{1}{ ProducerFinalizeLock}
\fl{ \.{\lor}}\al{190}{1}{ ProducerSubmit}
\fl{ \.{\lor}}\al{191}{1}{ ProducerDiscard}
\fl{ \.{\lor}}\al{192}{1}{ ConsumerNext}
\fl{ \.{\lor}}\al{193}{1}{ ConsumerReturn}
\fl{ \.{\lor}}\al{194}{1}{ AsyncQuery}
\fl{ \.{\lor}}\al{195}{1}{ AsyncCancel}
\fl{ \.{\lor}}\al{196}{1}{ AsyncComplete}
\fl{}
