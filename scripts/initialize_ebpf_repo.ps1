...
# Accept architecture as a parameter
param (
...
$commands = @(
    ...
    "cmake -G 'Visual Studio 17 2022' -S external\ebpf-verifier -B external\ebpf-verifier\build -A $Architecture",
    "cmake -G 'Visual Studio 17 2022' -S external\catch2 -B external\catch2\build -DBUILD_TESTING=OFF -A $Architecture",
    "cmake -G 'Visual Studio 17 2022' -S external\ubpf -B external\ubpf\build -A $Architecture",
