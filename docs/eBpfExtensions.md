...
4. `post_process_map_find_element` - Function to post-process a map entry after lookup.
5. `pre_process_map_update_element` - Function to pre-process a map entry before an add/update operation.
5. `pre_process_map_delete_element` - Function to pre-process a map entry before a delete operation.
