...
typedef struct _ebpf_program_info
{
    ...
    uint32_t count_of_program_specific_helpers;
    MIDL([size_is(count_of_program_specific_helpers)])
    ebpf_helper_function_prototype_t* program_specific_helper_prototype;
...
typedef struct _ebpf_program_data
{
    ...
    ebpf_helper_function_addresses_t* program_specific_helper_function_addresses;
