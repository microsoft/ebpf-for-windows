...
typedef enum
{
    ...
    BPF_FUNC_get_user_process_id = 20,       ///< \ref bpf_get_user_process_id
    BPF_FUNC_get_user_logon_id = 21,         ///< \ref bpf_get_user_logon_id
    BPF_FUNC_is_user_admin = 22,             ///< \ref bpf_is_user_admin
} ebpf_helper_id_t;
