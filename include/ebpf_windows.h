...
#define EBPF_MAP_PROVIDER_DATA_HEADER                                                        \
    {                                                                                        \
        EBPF_MAP_PROVIDER_DATA_CURRENT_VERSION, EBPF_MAP_PROVIDER_DATA_CURRENT_VERSION_SIZE, \
...
#define EBPF_MAP_CLIENT_DATA_HEADER                                                      \
    {                                                                                    \
        EBPF_MAP_CLIENT_DATA_CURRENT_VERSION, EBPF_MAP_CLIENT_DATA_CURRENT_VERSION_SIZE, \
...
#define EBPF_BASE_MAP_PROVIDER_PROPERTIES_HEADER                                                                   \
    {                                                                                                              \
        EBPF_BASE_MAP_PROVIDER_PROPERTIES_CURRENT_VERSION, EBPF_BASE_MAP_PROVIDER_PROPERTIES_CURRENT_VERSION_SIZE, \
...
#define EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_HEADER                                                                     \
    {                                                                                                                  \
        EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_CURRENT_VERSION, EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_CURRENT_VERSION_SIZE, \
